...
| --- | --- |
| ![Official Artwork](../assets/sprites/pelipper/official_artwork.png "Pelipper") | ![Shiny Artwork](../assets/sprites/pelipper/official_artwork_shiny.png "Pelipper") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/pelipper/front.gif "Pelipper") | ![Back](../assets/sprites/pelipper/back.gif "Pelipper") | ![Front Shiny](../assets/sprites/pelipper/front_shiny.gif "Pelipper") | ![Back Shiny](../assets/sprites/pelipper/back_shiny.gif "Pelipper") |
...
|------------|---------|--------|--------|-----------|---------|
| #279 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.2 m /<br>3.9 ft | 28.0 kg /<br>61.7 lbs |  | 1. <span class="tooltip" title="Prevents other Pokémon from lowering accuracy.">Keen Eye</span><br>2. <span class="tooltip" title="The Pokémon gradually regains HP in rain.">Rain Dish</span> | N/A |
...
| 1 | <span class="tooltip" title="Changes the target to pure water-type until it leaves the field.  If the target has multitype, this move will fail.">Soak</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
...
| 11 | <span class="tooltip" title="The foe is struck with large, imposing wings spread wide to inflict damage. ">Wing Attack</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 75 | 100 | 35 |
...
| 24 | <span class="tooltip" title="If the user can use this attack after the foe attacks, its power is doubled. ">Payback</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 100 | 10 |
...
| 31 | <span class="tooltip" title="The user lands and rests its body. It restores the user’s HP by up to half of its max HP.">Roost</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
| 38 | <span class="tooltip" title="The power stored using the move Stockpile is released at once in an attack. ">Spit Up</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 100 | 10 |
| 38 | <span class="tooltip" title="The user charges up power, and raises both its Defense and Sp. Def. The move can be used three times.">Stockpile</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 38 | <span class="tooltip" title="The power stored using the move Stockpile is absorbed by the user to heal its HP.">Swallow</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
...
| 50 | <span class="tooltip" title="The user whips up a turbulent whirlwind that ups the Speed of all party Pokémon for three turns.">Tailwind</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
...
| 63 | <span class="tooltip" title="Inflicts regular damage.">Hurricane</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 110 | 70 | 10 |
