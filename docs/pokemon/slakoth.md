...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/slakoth/official_artwork.png "Slakoth") | ![Shiny Artwork](../assets/sprites/slakoth/official_artwork_shiny.png "Slakoth") |
...
|-------|-------|------|-------|
| ![Slakoth](../assets/sprites/slakoth/front.gif "Slakoth: It spends nearly all its time in a day sprawled out. Just seeing it makes one drowsy.") | ![Slakoth](../assets/sprites/slakoth/front_shiny.gif "Slakoth: It spends nearly all its time in a day sprawled out. Just seeing it makes one drowsy.") | ![Slakoth](../assets/sprites/slakoth/back.gif "Slakoth: It spends nearly all its time in a day sprawled out. Just seeing it makes one drowsy.") | ![Slakoth](../assets/sprites/slakoth/back_shiny.gif "Slakoth: It spends nearly all its time in a day sprawled out. Just seeing it makes one drowsy.") |
...
|------------|---------|--------|--------|-----------|---------|
| #287 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.8 m /<br>2.6 ft | 24.0 kg /<br>52.9 lbs | 1. <span class="tooltip" title="Pokémon can’t attack on consecutive turns.">Truant</span><br>2. <span class="tooltip" title="Temporarily halves Attack and Speed.">Slow Start</span> | N/A |
