...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/gothita/front.gif "Gothita") | ![Back](../assets/sprites/gothita/back.gif "Gothita") | ![Front Shiny](../assets/sprites/gothita/front_shiny.gif "Gothita") | ![Back Shiny](../assets/sprites/gothita/back_shiny.gif "Gothita") |
...
| 35 | <span class="tooltip" title="Inflicts regular damage.  Damage is calculated using the target's attacking stat rather than the user's.">Foul Play</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 95 | 100 | 15 |
...
| 48 | <span class="tooltip" title="For five turns (including this one), passive effects of held items are ignored, and Pokémon will not use their held items.">Magic Room</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
