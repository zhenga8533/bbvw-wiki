...
|------------|---------|--------|--------|-----------|---------|
| #264 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.5 m /<br>1.6 ft | 32.5 kg /<br>71.7 lbs | <span class="tooltip" title="The Pokémon may pick up items.">Pickup</span><br><span class="tooltip" title="Boosts Speed if there is a status problem.">Quick Feet</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Speed | 90 | 50 | 147 | Medium | <span class="tooltip" title="If held by a Pokémon,  it heals the user by just 10 HP.">Oran Berry</span> (50%)<br><span class="tooltip" title="If held by a Pokémon, it heals the user’s HP a little.">Sitrus Berry</span> (5%) |
