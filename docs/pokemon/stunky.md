...
| --- | --- |
| ![Official Artwork](../assets/sprites/stunky/official_artwork.png "Stunky") | ![Shiny Artwork](../assets/sprites/stunky/official_artwork_shiny.png "Stunky") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/stunky/front.gif "Stunky") | ![Back](../assets/sprites/stunky/back.gif "Stunky") | ![Front Shiny](../assets/sprites/stunky/front_shiny.gif "Stunky") | ![Back Shiny](../assets/sprites/stunky/back_shiny.gif "Stunky") |
...
| 18 | <span class="tooltip" title="This move enables the user to attack first. It fails if the foe is not readying an attack, however.">Sucker Punch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
...
| 25 | <span class="tooltip" title="Inflicts regular damage.  If this move successfully hits the target, any Pokémon adjacent to the target are damaged for 1/16 their max HP.">Flame Burst</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 70 | 100 | 15 |
...
| 55 | <span class="tooltip" title="Inflicts regular damage.  Damage is calculated using the target's attacking stat rather than the user's.">Foul Play</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 95 | 100 | 15 |
