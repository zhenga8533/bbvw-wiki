...
|------------|---------|--------|--------|-----------|---------|
| #180 | ![electric](../assets/types/electric.png "Electric"){: width="48"} | 0.8 m /<br>2.6 ft | 13.3 kg /<br>29.3 lbs | <span class="tooltip" title="Contact with the Pokémon may cause paralysis.">Static</span><br><span class="tooltip" title="Protects the Pokémon from damage from weather.">Overcoat</span> | N/A |
