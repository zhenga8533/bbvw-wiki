...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/sunflora/front.gif "Sunflora") | ![Back](../assets/sprites/sunflora/back.gif "Sunflora") | ![Front Shiny](../assets/sprites/sunflora/front_shiny.gif "Sunflora") | ![Back Shiny](../assets/sprites/sunflora/back_shiny.gif "Sunflora") |
...
| 7 | <span class="tooltip" title="The user lays roots that restore HP on every turn. Because it is rooted, it can’t switch out.">Ingrain</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 34 | <span class="tooltip" title="A storm of sharp leaves is whipped up. The attack’s recoil sharply reduces the user’s Sp. Atk stat.">Leaf Storm</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 130 | 90 | 5 |
| 38 | <span class="tooltip" title="Inflicts regular damage.  Has a 50% chance to raise the user's Special Attack by one stage.">Fiery Dance</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 10 |
