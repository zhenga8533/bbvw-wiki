...
| --- | --- |
| ![Official Artwork](../assets/sprites/clefairy/official_artwork.png "Clefairy") | ![Shiny Artwork](../assets/sprites/clefairy/official_artwork_shiny.png "Clefairy") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/clefairy/front.gif "Clefairy") | ![Back](../assets/sprites/clefairy/back.gif "Clefairy") | ![Front Shiny](../assets/sprites/clefairy/front_shiny.gif "Clefairy") | ![Back Shiny](../assets/sprites/clefairy/back_shiny.gif "Clefairy") |
...
|------------|---------|--------|--------|-----------|---------|
| #35 | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.6 m /<br>2.0 ft | 7.5 kg /<br>16.5 lbs |  | 1. <span class="tooltip" title="Contact with the Pokémon may cause infatuation.">Cute Charm</span><br>2. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | N/A |
...
| 16 | <span class="tooltip" title="The user draws attention to itself, making all foes take aim only at the user. ">Follow Me</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 22 | <span class="tooltip" title="This attack inflicts high damage on a sleeping foe. It also wakes the foe up, however.">Wake Up Slap</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 10 |
| 25 | <span class="tooltip" title="Transfers the user's held item to the target.  If the user has no held item, or the target already has a held item, this move will fail.">Bestow</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
| 28 | <span class="tooltip" title="The user absorbs a mystical power from space to raise its Defense and Sp. Def stats.">Cosmic Power</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 34 | <span class="tooltip" title="The user releases a soothing scent that heals all status problems affecting the user’s party.">Aromatherapy</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
...
| 40 | <span class="tooltip" title="The user restores its own HP. The amount of HP regained varies with the weather.">Moonlight</span> | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
...
| 52 | <span class="tooltip" title="The target will act next this turn, regardless of Speed or move priority. If the target has already acted this turn, this move will fail.">After You</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
| 55 | <span class="tooltip" title="The foe is hit with a hard punch fired like a meteor. It may also raise the user’s Attack.">Meteor Mash</span> | ![steel](../assets/types/steel.png "Steel"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 90 | 10 |
