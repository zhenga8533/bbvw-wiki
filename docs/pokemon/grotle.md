...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/grotle/front.gif "Grotle") | ![Back](../assets/sprites/grotle/back.gif "Grotle") | ![Front Shiny](../assets/sprites/grotle/front_shiny.gif "Grotle") | ![Back Shiny](../assets/sprites/grotle/back_shiny.gif "Grotle") |
...
|------------|---------|--------|--------|-----------|---------|
| #388 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 1.1 m /<br>3.6 ft | 97.0 kg /<br>213.8 lbs | <span class="tooltip" title="Powers up Grass-type moves in a pinch.">Overgrow</span><br><span class="tooltip" title="It cannot be knocked out with one hit.">Sturdy</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Attack<br>1 Defense | 45 | 70 | 142 | Medium Slow | <span class="tooltip" title="An item to be held by a Pokémon. It is a seed imbued with life that ups the power of Grass-type moves.">Miracle Seed</span> (50%) |
...
| 32 | <span class="tooltip" title="A seed is planted on the foe. It steals some HP from the foe to heal the user on every turn.">Leech Seed</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 90 | 10 |
