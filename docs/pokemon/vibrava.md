...
|------------|---------|--------|--------|-----------|---------|
| #329 | ![bug](../assets/types/bug.png){: width='48'} ![dragon](../assets/types/dragon.png){: width='48'} | 1.1 m /<br>3.6 ft | 15.3 kg /<br>33.7 lbs | <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span> | N/A |
