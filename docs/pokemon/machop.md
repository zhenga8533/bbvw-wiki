...
| --- | --- |
| ![Official Artwork](../assets/sprites/machop/official_artwork.png "Machop") | ![Shiny Artwork](../assets/sprites/machop/official_artwork_shiny.png "Machop") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/machop/front.gif "Machop") | ![Back](../assets/sprites/machop/back.gif "Machop") | ![Front Shiny](../assets/sprites/machop/front_shiny.gif "Machop") | ![Back Shiny](../assets/sprites/machop/back_shiny.gif "Machop") |
...
|------------|---------|--------|--------|-----------|---------|
| #66 | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | 0.8 m /<br>2.6 ft | 19.5 kg /<br>43.0 lbs | <span class="tooltip" title="Boosts Attack if there is a status problem.">Guts</span><br><span class="tooltip" title="Ensures attacks by or against the Pokémon land.">No Guard</span> | N/A |
...
| 31 | <span class="tooltip" title="The user allows the foe to attack first. In return, this throw move is guaranteed not to miss.">Vital Throw</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | — | 10 |
| 34 | <span class="tooltip" title="Inflicts regular damage.  Has a 10% chance to lower the target's Attack by one stage.">Play Rough</span> | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 90 | 10 |
| 37 | <span class="tooltip" title="This attack inflicts high damage on a sleeping foe. It also wakes the foe up, however.">Wake Up Slap</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 10 |
...
| 49 | <span class="tooltip" title="The foe is punched with the user’s full, concentrated power. It confuses the foe if it hits.">Dynamic Punch</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 100 | 50 | 5 |
