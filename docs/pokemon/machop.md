...
|------------|---------|--------|--------|-----------|---------|
| #66 | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | 0.8 m /<br>2.6 ft | 19.5 kg /<br>43.0 lbs |  | 1. <span class="tooltip" title="Boosts Attack if there is a status problem.">Guts</span><br>2. <span class="tooltip" title="Ensures attacks by or against the Pokémon land.">No Guard</span> | N/A |
