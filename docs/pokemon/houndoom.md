...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/houndoom/front.gif "Houndoom") | ![Back](../assets/sprites/houndoom/back.gif "Houndoom") | ![Front Shiny](../assets/sprites/houndoom/front_shiny.gif "Houndoom") | ![Back Shiny](../assets/sprites/houndoom/back_shiny.gif "Houndoom") |

### Female Sprites

| Front | Back | Front Shiny | Back Shiny |
| --- | --- | --- | --- |
| ![Front](../assets/sprites/houndoom/front_female.gif "Houndoom") | ![Back](../assets/sprites/houndoom/back_female.gif "Houndoom") | ![Front Shiny](../assets/sprites/houndoom/front_shiny_female.gif "Houndoom") | ![Back Shiny](../assets/sprites/houndoom/back_shiny_female.gif "Houndoom") |
...
|------------|---------|--------|--------|-----------|---------|
| #229 | ![dark](../assets/types/dark.png "Dark"){: width="48"} ![fire](../assets/types/fire.png "Fire"){: width="48"} | 1.4 m /<br>4.6 ft | 35.0 kg /<br>77.2 lbs | <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span><br><span class="tooltip" title="It powers up Fire-type moves if it’s hit by one.">Flash Fire</span> | N/A |
...
| 13 | <span class="tooltip" title="The foe is scared off, to be replaced by another Pokémon in its party. In the wild, the battle ends.">Roar</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 20 | <span class="tooltip" title="Enables the user to hit a Ghost type with any type of move. It also enables the user to hit an evasive foe.">Odor Sleuth</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 40 |
| 23 | <span class="tooltip" title="Inflicts regular damage.  Has a 100% chance to lower the target's Special Attack by one stage.">Snarl</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 60 | 95 | 15 |
| 26 | <span class="tooltip" title="The user gets all the party Pokémon to attack the foe. The more party Pokémon, the more damage.">Beat Up</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 10 |
...
| 50 | <span class="tooltip" title="The foe is scorched with an intense blast of fire. The target may also be left with a burn.">Flamethrower</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 15 |
| 56 | <span class="tooltip" title="The user crunches up the foe with sharp fangs. It may also lower the target’s Defense stat.">Crunch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
...
| 65 | <span class="tooltip" title="Inflicts regular damage.  Has a 100% chance to burn the target.">Inferno</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 100 | 50 | 5 |
