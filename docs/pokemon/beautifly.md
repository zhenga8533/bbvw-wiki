...
|------------|---------|--------|--------|-----------|---------|
| #267 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.0 m /<br>3.3 ft | 28.4 kg /<br>62.6 lbs | <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br><span class="tooltip" title="Blocks the added effects of attacks taken.">Shield Dust</span> | N/A |
