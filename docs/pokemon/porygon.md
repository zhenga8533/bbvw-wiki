...
|------------|---------|--------|--------|-----------|---------|
| #137 | ![normal](../assets/types/normal.png){: width='48'} | 0.8 m /<br>2.6 ft | 36.5 kg /<br>80.5 lbs | <span class="tooltip" title="The Pokémon copies a foe’s Ability.">Trace</span><br><span class="tooltip" title="Adjusts power according to a foe’s defenses.">Download</span> | N/A |
...
| 1 | <span class="tooltip" title="The user reduces its polygon count to make itself more jagged, raising the Attack stat.">Sharpen</span> | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 30 |
...
| 67 | <span class="tooltip" title="Gravity is intensified for five turns, making moves involving flying unusable and negating Levitation.">Gravity</span> | ![psychic](../assets/types/psychic.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 5 |
