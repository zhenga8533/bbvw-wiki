...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/herdier/front.gif "Herdier") | ![Back](../assets/sprites/herdier/back.gif "Herdier") | ![Front Shiny](../assets/sprites/herdier/front_shiny.gif "Herdier") | ![Back Shiny](../assets/sprites/herdier/back_shiny.gif "Herdier") |
...
|------------|---------|--------|--------|-----------|---------|
| #507 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.9 m /<br>3.0 ft | 14.7 kg /<br>32.4 lbs | <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span><br><span class="tooltip" title="Enables moves to hit Ghost-type Pokémon.">Scrappy</span> | #13 |
...
| 33 | <span class="tooltip" title="Inflicts regular damage.  If a friendly Pokémon fainted on the previous turn, this move has double power.">Retaliate</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
...
| 47 | <span class="tooltip" title="The user charges at the foe using every bit of its power. The user must rest on the next turn.">Giga Impact</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 150 | 90 | 5 |
