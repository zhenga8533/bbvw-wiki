...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/remoraid/front.gif "Remoraid") | ![Back](../assets/sprites/remoraid/back.gif "Remoraid") | ![Front Shiny](../assets/sprites/remoraid/front_shiny.gif "Remoraid") | ![Back Shiny](../assets/sprites/remoraid/back_shiny.gif "Remoraid") |
...
|------------|---------|--------|--------|-----------|---------|
| #223 | ![water](../assets/types/water.png "Water"){: width="48"} | 0.6 m /<br>2.0 ft | 12.0 kg /<br>26.5 lbs |  | 1. <span class="tooltip" title="Raises one stat and lowers another.">Moody</span><br>2. <span class="tooltip" title="Powers up moves if they become critical hits.">Sniper</span> | N/A |
...
| 6 | <span class="tooltip" title="The user takes sure aim at the foe. It ensures the next attack does not fail to hit the target.">Lock On</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
...
| 27 | <span class="tooltip" title="The user forcefully shoots seeds at the foe. Two to five seeds are shot in rapid succession.">Bullet Seed</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 25 | 100 | 30 |
| 32 | <span class="tooltip" title="The user attacks the foe with a pulsing blast of water. It may also confuse the foe.">Water Pulse</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 60 | 100 | 20 |
...
| 40 | <span class="tooltip" title="The foe is struck with an icy-cold beam of energy. It may also freeze the target solid.">Ice Beam</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 10 |
...
| 49 | <span class="tooltip" title="Changes the target to pure water-type until it leaves the field.  If the target has multitype, this move will fail.">Soak</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
