...
|------------|---------|--------|--------|-----------|---------|
| #10004 | ![bug](../assets/types/bug.png){: width='48'} ![ground](../assets/types/ground.png){: width='48'} | 0.5 m /<br>1.6 ft | 6.5 kg /<br>14.3 lbs | <span class="tooltip" title="Senses a foe’s dangerous moves.">Anticipation</span><br><span class="tooltip" title="Boosts the Pokémon’s evasion in a sandstorm.">Sand Veil</span> | N/A |
...
| 26 | <span class="tooltip" title="The user hurls hard rocks at the foe. Two to five rocks are launched in quick succession.">Rock Blast</span> | ![rock](../assets/types/rock.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 25 | 90 | 10 |
| 29 | <span class="tooltip" title="The user stiffens all the muscles in its body to raise its Defense stat. ">Harden</span> | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 30 |
