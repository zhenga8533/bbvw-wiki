...
|------------|---------|--------|--------|-----------|---------|
| #48 | ![bug](../assets/types/bug.png "Bug"){: width="48"} ![poison](../assets/types/poison.png "Poison"){: width="48"} | 1.0 m /<br>3.3 ft | 30.0 kg /<br>66.1 lbs | <span class="tooltip" title="The Pokémon’s accuracy is boosted.">Compound Eyes</span><br><span class="tooltip" title="Powers up “not very effective” moves.">Tinted Lens</span> | N/A |
