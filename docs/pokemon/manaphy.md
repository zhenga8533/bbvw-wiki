...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/manaphy/front.gif "Manaphy") | ![Back](../assets/sprites/manaphy/back.gif "Manaphy") | ![Front Shiny](../assets/sprites/manaphy/front_shiny.gif "Manaphy") | ![Back Shiny](../assets/sprites/manaphy/back_shiny.gif "Manaphy") |
...
|------------|---------|--------|--------|-----------|---------|
| #490 | ![water](../assets/types/water.png "Water"){: width="48"} | 0.3 m /<br>1.0 ft | 1.4 kg /<br>3.1 lbs |  | 1. <span class="tooltip" title="Heals status problems if it is raining.">Hydration</span><br>2. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | N/A |
...
| 24 | <span class="tooltip" title="A spray of bubbles is forcefully ejected at the foe. It may also lower the target’s Speed stat.">Bubble Beam</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 75 | 100 | 15 |
...
| 46 | <span class="tooltip" title="The user attacks the foe with a pulsing blast of water. It may also confuse the foe.">Water Pulse</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 60 | 100 | 20 |
...
| 61 | <span class="tooltip" title="A two-turn attack. The user dives underwater on the first turn, then hits on the next turn.">Dive</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 10 |
...
| 76 | <span class="tooltip" title="The user employs its psychic power to switch stat changes with the foe. ">Heart Swap</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
