...
|------------|---------|--------|--------|-----------|---------|
| #315 | ![grass](../assets/types/grass.png "Grass"){: width="48"} ![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.3 m /<br>1.0 ft | 2.0 kg /<br>4.4 lbs | <span class="tooltip" title="All status problems heal when it switches out.">Natural Cure</span><br><span class="tooltip" title="Contact with the Pokémon may poison the attacker.">Poison Point</span> | N/A |
