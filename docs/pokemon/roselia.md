...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/roselia/front.gif "Roselia") | ![Back](../assets/sprites/roselia/back.gif "Roselia") | ![Front Shiny](../assets/sprites/roselia/front_shiny.gif "Roselia") | ![Back Shiny](../assets/sprites/roselia/back_shiny.gif "Roselia") |

### Female Sprites

| Front | Back | Front Shiny | Back Shiny |
| --- | --- | --- | --- |
| ![Front](../assets/sprites/roselia/front_female.gif "Roselia") | ![Back](../assets/sprites/roselia/back_female.gif "Roselia") | ![Front Shiny](../assets/sprites/roselia/front_shiny_female.gif "Roselia") | ![Back Shiny](../assets/sprites/roselia/back_shiny_female.gif "Roselia") |
...
| 16 | <span class="tooltip" title="A seed is planted on the foe. It steals some HP from the foe to heal the user on every turn.">Leech Seed</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 90 | 10 |
...
| 31 | <span class="tooltip" title="A sweet scent that lowers the foe’s evasiveness. It also lures wild Pokémon if used in grass, etc.">Sweet Scent</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
| 34 | <span class="tooltip" title="The user lays roots that restore HP on every turn. Because it is rooted, it can’t switch out.">Ingrain</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 55 | <span class="tooltip" title="Raises the user's Special Attack, Special Defense, and Speed by one stage each.">Quiver Dance</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
