...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/sewaddle/front.gif "Sewaddle") | ![Back](../assets/sprites/sewaddle/back.gif "Sewaddle") | ![Front Shiny](../assets/sprites/sewaddle/front_shiny.gif "Sewaddle") | ![Back Shiny](../assets/sprites/sewaddle/back_shiny.gif "Sewaddle") |
...
| 29 | <span class="tooltip" title="The user endures any attack, leaving 1 HP. Its chance of failing rises if it is used in succession.">Endure</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
