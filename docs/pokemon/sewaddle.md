...
Latest (Gen VI+):
<p><audio controls>
  <source src='../assets/cries/540/latest.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>

Legacy:
<p><audio controls>
  <source src='../assets/cries/540/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>
...
|------------|---------|--------|--------|-----------|---------|
| #540 | ![bug](../assets/types/bug.png){: width='48'} ![grass](../assets/types/grass.png){: width='48'} | 0.3 m | 2.5 kg | 1. Swarm<br>2. Chlorophyll | #46 |
