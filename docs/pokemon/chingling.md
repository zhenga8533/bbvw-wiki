...
|------------|---------|--------|--------|-----------|---------|
| #433 | ![psychic](../assets/types/psychic.png){: width='48'} | 0.2 m /<br>0.7 ft | 0.6 kg /<br>1.3 lbs | <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span> | N/A |
...
| 22 | <span class="tooltip" title="This move can be used only after the user has used all the other moves it knows in the battle.">Last Resort</span> | ![normal](../assets/types/normal.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 140 | 100 | 5 |
