...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/rotom-heat/official_artwork.png "Rotom Heat") | ![Shiny Artwork](../assets/sprites/rotom-heat/official_artwork_shiny.png "Rotom Heat") |
...
|-------|-------|------|-------|
| ![Rotom Heat](../assets/sprites/rotom-heat/front.gif "Rotom Heat: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Heat](../assets/sprites/rotom-heat/front_shiny.gif "Rotom Heat: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Heat](../assets/sprites/rotom-heat/back.gif "Rotom Heat: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Heat](../assets/sprites/rotom-heat/back_shiny.gif "Rotom Heat: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") |
...
| 1 | <span class="tooltip" title="An inferno of scarlet flames torches everything around the user. It may leave targets with a burn.">Lava Plume</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 15 |
