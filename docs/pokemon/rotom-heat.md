...
| --- | --- |
| ![Official Artwork](../assets/sprites/rotom-heat/official_artwork.png) | ![Shiny Artwork](../assets/sprites/rotom-heat/official_artwork_shiny.png) |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/rotom-heat/front.gif) | ![Back](../assets/sprites/rotom-heat/back.gif) | ![Front Shiny](../assets/sprites/rotom-heat/front_shiny.gif) | ![Back Shiny](../assets/sprites/rotom-heat/back_shiny.gif) |
...
|------------|---------|--------|--------|-----------|---------|
| #10008 | ![electric](../assets/types/electric.png){: width='48'} ![fire](../assets/types/fire.png){: width='48'} | 0.3 m /<br>1.0 ft | 0.3 kg /<br>0.7 lbs | <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span> | N/A |
...
| 1 | <span class="tooltip" title="An inferno of scarlet flames washes over all Pokémon in battle. It may also inflict burns.">Lava Plume</span> | ![fire](../assets/types/fire.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 80 | 100 | 15 |
