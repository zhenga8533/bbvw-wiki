...
|------------|---------|--------|--------|-----------|---------|
| #93 | ![ghost](../assets/types/ghost.png){: width='48'} ![poison](../assets/types/poison.png){: width='48'} | 1.6 m /<br>5.2 ft | 0.1 kg /<br>0.2 lbs | <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span> | N/A |
