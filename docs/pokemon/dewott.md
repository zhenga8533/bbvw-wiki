...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/dewott/front.gif "Dewott") | ![Back](../assets/sprites/dewott/back.gif "Dewott") | ![Front Shiny](../assets/sprites/dewott/front_shiny.gif "Dewott") | ![Back Shiny](../assets/sprites/dewott/back_shiny.gif "Dewott") |
...
| 36 | <span class="tooltip" title="The user compels the foe to keep using only the move it last used for three to seven turns.">Encore</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 5 |
...
| 44 | <span class="tooltip" title="Inflicts regular damage.  If a friendly Pokémon fainted on the previous turn, this move has double power.">Retaliate</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
