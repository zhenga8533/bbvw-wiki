...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/dewott/official_artwork.png "Dewott") | ![Shiny Artwork](../assets/sprites/dewott/official_artwork_shiny.png "Dewott") |
...
|-------|-------|------|-------|
| ![Dewott](../assets/sprites/dewott/front.gif "Dewott: Scalchop techniques differ from one Dewott to another. It never neglects maintaining its scalchops.") | ![Dewott](../assets/sprites/dewott/front_shiny.gif "Dewott: Scalchop techniques differ from one Dewott to another. It never neglects maintaining its scalchops.") | ![Dewott](../assets/sprites/dewott/back.gif "Dewott: Scalchop techniques differ from one Dewott to another. It never neglects maintaining its scalchops.") | ![Dewott](../assets/sprites/dewott/back_shiny.gif "Dewott: Scalchop techniques differ from one Dewott to another. It never neglects maintaining its scalchops.") |
...
|------------|---------|--------|--------|-----------|---------|
| #502 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | 0.8 m /<br>2.6 ft | 24.5 kg /<br>54.0 lbs | 1. <span class="tooltip" title="Powers up Water-type moves in a pinch.">Torrent</span><br>2. <span class="tooltip" title="Prevents the Pokémon from falling asleep.">Vital Spirit</span> | N/A |
...
| 44 | <span class="tooltip" title="The user gets revenge for a fainted ally. If an ally fainted in the previous turn, this attack’s damage increases.">Retaliate</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
