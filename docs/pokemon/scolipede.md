...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/scolipede/front.gif "Scolipede") | ![Back](../assets/sprites/scolipede/back.gif "Scolipede") | ![Front Shiny](../assets/sprites/scolipede/front_shiny.gif "Scolipede") | ![Back Shiny](../assets/sprites/scolipede/back_shiny.gif "Scolipede") |
...
| 28 | <span class="tooltip" title="Inflicts regular damage.  If the target is poisoned, this move has double power.">Venoshock</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
...
| 39 | <span class="tooltip" title="Inflicts regular damage.  Has a 30% chance to make the target flinch.  Power is doubled against Pokémon that have used minimize since entering the field.">Steamroller</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 20 |
...
| 50 | <span class="tooltip" title="A charging attack that may also leave the foe confused. It can also be used to scale rocky walls.">Rock Climb</span> | ![Rock](../assets/types/rock.png "Rock"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 95% | 10 |
