...
Latest (Gen VI+):
<p><audio controls>
  <source src='../assets/cries/545/latest.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>

Legacy:
<p><audio controls>
  <source src='../assets/cries/545/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>
...
|------------|---------|--------|--------|-----------|---------|
| #545 | ![bug](../assets/types/bug.png){: width='48'} ![poison](../assets/types/poison.png){: width='48'} | 2.5 m | 200.5 kg | 1. Poison-Touch<br>2. Swarm | #51 |
