...
| --- | --- |
| ![Official Artwork](https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/10088.png) | ![Shiny Artwork](https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/shiny/10088.png) |
...
| Front | Shiny Front |
| --- | --- |
| ![Front](https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/10088.png) | ![Shiny Front](https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/shiny/10088.png) |

### Cries

Latest (Gen VI+):
<p><audio controls>
  <source src="https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/10088.ogg" type="audio/ogg">
...
|------------|---------|--------|--------|-----------|---------|
| #10088 | ![normal](../assets/types/normal.png){: width='48'} ![fighting](../assets/types/fighting.png){: width='48'} | 1.3 m | 28.3 kg | 1. Scrappy | #N/A |
...
|---|----|--------|---------|---------|---------|-------|
| **Base** | 65 | 136 | 94 | 54 | 96 | 135 |
| **Min** | 240 | 249 | 173 | 101 | 177 | 247 |
| **Max** | 334 | 408 | 315 | 227 | 320 | 405 |
...
1. [Lopunny](lopunny.md/)
2. [Lopunny-Mega](lopunny-mega.md/)
...
|-----|------|------|------|-------|------|----|
| 0 | Return | ![normal](../assets/types/normal.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | — | 100 | 20 |
...
| 1 | Magic Coat | ![psychic](../assets/types/psychic.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 15 |
...
| 1 | Return | ![normal](../assets/types/normal.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | — | 100 | 20 |
...
| 13 | Baby Doll Eyes | ![fairy](../assets/types/fairy.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | 100 | 30 |
...
| 66 | High Jump Kick | ![fighting](../assets/types/fighting.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 130 | 90 | 10 |

### TM Moves

| TM | Move | Type | Cat. | Power | Acc. | PP |
|----|------|------|------|-------|------|----|
| TM01 | Work Up | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/physical.png){: width='36'} | — | — | 30 |
...
Lopunny Mega cannot learn any moves by breeding.
