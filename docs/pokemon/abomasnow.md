...
|------------|---------|--------|--------|-----------|---------|
| #460 | ![grass](../assets/types/grass.png){: width='48'} ![ice](../assets/types/ice.png){: width='48'} | 2.2 m /<br>7.2 ft | 135.5 kg /<br>298.7 lbs | <span class="tooltip" title="The Pokémon summons a hailstorm in battle.">Snow Warning</span><br><span class="tooltip" title="Gives full immunity to all sound-based moves.">Soundproof</span> | N/A |
...
| 47 | <span class="tooltip" title="A howling blizzard is summoned to strike the foe. It may also freeze the target solid.">Blizzard</span> | ![ice](../assets/types/ice.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 110 | 70 | 5 |
...
| 69 | <span class="tooltip" title="The user slams a barrage of hard- shelled seeds down on the foe from above.">Seed Bomb</span> | ![grass](../assets/types/grass.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 80 | 100 | 15 |
