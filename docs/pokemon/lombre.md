...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/lombre/front.gif "Lombre") | ![Back](../assets/sprites/lombre/back.gif "Lombre") | ![Front Shiny](../assets/sprites/lombre/front_shiny.gif "Lombre") | ![Back Shiny](../assets/sprites/lombre/back_shiny.gif "Lombre") |
...
| 11 | <span class="tooltip" title="An attack that hits first and makes the target flinch. This move works only on the first turn.">Fake Out</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 100 | 10 |
