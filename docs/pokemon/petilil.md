...
Latest (Gen VI+):
<p><audio controls>
  <source src='../assets/cries/548/latest.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>

Legacy:
<p><audio controls>
  <source src='../assets/cries/548/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>
...
|------------|---------|--------|--------|-----------|---------|
| #548 | ![grass](../assets/types/grass.png){: width='48'} | 0.5 m | 6.6 kg | 1. Chlorophyll<br>2. Leaf-Guard | #54 |
