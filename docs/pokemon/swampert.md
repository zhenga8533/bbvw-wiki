...
| --- | --- |
| ![Official Artwork](../assets/sprites/swampert/official_artwork.png "Swampert") | ![Shiny Artwork](../assets/sprites/swampert/official_artwork_shiny.png "Swampert") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/swampert/front.gif "Swampert") | ![Back](../assets/sprites/swampert/back.gif "Swampert") | ![Front Shiny](../assets/sprites/swampert/front_shiny.gif "Swampert") | ![Back Shiny](../assets/sprites/swampert/back_shiny.gif "Swampert") |
...
|------------|---------|--------|--------|-----------|---------|
| #260 | ![water](../assets/types/water.png "Water"){: width="48"} ![ground](../assets/types/ground.png "Ground"){: width="48"} | 1.5 m /<br>4.9 ft | 81.9 kg /<br>180.6 lbs | <span class="tooltip" title="Powers up Water-type moves in a pinch.">Torrent</span><br><span class="tooltip" title="Moves can be used regardless of Abilities.">Mold Breaker</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 3 Attack | 45 | 50 | 268 | Medium Slow | <span class="tooltip" title="An item to be held by a Pokémon. It is a teardrop-shaped gem that ups the power of Water-type moves.">Mystic Water</span> (50%) |
...
| 20 | <span class="tooltip" title="Enables the user to hit a Ghost type with any type of move. It also enables the user to hit an evasive foe.">Foresight</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 40 |
...
| 39 | <span class="tooltip" title="The user attacks by shooting out muddy water. It may also lower the foe’s accuracy.">Muddy Water</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 85 | 10 |
| 46 | <span class="tooltip" title="It enables the user to evade all attacks. Its chance of failing rises if it is used in succession.">Protect</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
| 52 | <span class="tooltip" title="The user sets off an earthquake that hits all the Pokémon in the battle. ">Earthquake</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 100 | 100 | 10 |
| 61 | <span class="tooltip" title="An attack move that cuts down the foe’s HP to equal the user’s HP. ">Endeavor</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 5 |
