...
Latest (Gen VI+):
<p><audio controls>
  <source src='../assets/cries/512/latest.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>

Legacy:
<p><audio controls>
  <source src='../assets/cries/512/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>
...
|------------|---------|--------|--------|-----------|---------|
| #512 | ![grass](../assets/types/grass.png){: width='48'} | 1.1 m | 30.5 kg | 1. Unburden<br>2. Overgrow | #18 |
