...
|------------|---------|--------|--------|-----------|---------|
| #24 | ![poison](../assets/types/poison.png){: width='48'} | 3.5 m /<br>11.5 ft | 65.0 kg /<br>143.3 lbs | <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span><br><span class="tooltip" title="The Pokémon may heal its own status problems.">Shed Skin</span> | N/A |
...
| 23 | <span class="tooltip" title="An attack with a high critical-hit ratio. This tail  attack may also  poison the foe.">Poison Tail</span> | ![poison](../assets/types/poison.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 90 | 100 | 15 |
| 27 | <span class="tooltip" title="The power stored using the move Stockpile is released at once in an attack. ">Spit Up</span> | ![normal](../assets/types/normal.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | — | 100 | 10 |
...
| 27 | <span class="tooltip" title="The power stored using the move Stockpile is absorbed by the user to heal its HP.">Swallow</span> | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 10 |
...
| 39 | <span class="tooltip" title="The user launches a hard-packed mud ball to attack. It may also lower the target’s accuracy.">Mud Bomb</span> | ![ground](../assets/types/ground.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 65 | 85 | 10 |
| 44 | <span class="tooltip" title="The user hurls up its stomach acids on the foe. The fluid eliminates the effect of the foe’s ability.">Gastro Acid</span> | ![poison](../assets/types/poison.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | 100 | 10 |
| 51 | <span class="tooltip" title="The user creates a haze that eliminates every stat change among all the Pokémon engaged in battle.">Haze</span> | ![ice](../assets/types/ice.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 30 |
| 56 | <span class="tooltip" title="Raises the user's Attack, Defense, and accuracy by one stage each.">Coil</span> | ![poison](../assets/types/poison.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 20 |
| 63 | <span class="tooltip" title="The user shoots filthy garbage at the foe to attack. It may also poison the target.">Gunk Shot</span> | ![poison](../assets/types/poison.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 120 | 80 | 5 |
