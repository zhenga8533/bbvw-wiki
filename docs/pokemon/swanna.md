...
| --- | --- |
| ![Official Artwork](../assets/sprites/swanna/official_artwork.png "Swanna") | ![Shiny Artwork](../assets/sprites/swanna/official_artwork_shiny.png "Swanna") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/swanna/front.gif "Swanna") | ![Back](../assets/sprites/swanna/back.gif "Swanna") | ![Front Shiny](../assets/sprites/swanna/front_shiny.gif "Swanna") | ![Back Shiny](../assets/sprites/swanna/back_shiny.gif "Swanna") |
...
|------------|---------|--------|--------|-----------|---------|
| #581 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.3 m /<br>4.3 ft | 24.2 kg /<br>53.4 lbs |  | 1. <span class="tooltip" title="Heals status problems if it is raining.">Hydration</span><br>2. <span class="tooltip" title="Protects the Pokémon from Defense-lowering attacks.">Big Pecks</span> | #87 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | <span class="tooltip" title="Obstacles are moved, reducing the foe’s evasion stat. It can also be used to clear deep fog, etc.">Defog</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
...
| 6 | <span class="tooltip" title="Obstacles are moved, reducing the foe’s evasion stat. It can also be used to clear deep fog, etc.">Defog</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
| 9 | <span class="tooltip" title="The foe is struck with large, imposing wings spread wide to inflict damage. ">Wing Attack</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 75 | 100 | 35 |
...
| 21 | <span class="tooltip" title="The user covers the foe with a mass of down that sharply lowers the Attack stat.">Feather Dance</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
...
| 35 | <span class="tooltip" title="Inflicts regular damage.  If the user has no held item, this move has double power.">Acrobatics</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 55 | 100 | 15 |
...
| 47 | <span class="tooltip" title="The user tucks in its wings and charges from a low altitude. The user also takes serious damage.">Brave Bird</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 15 |
