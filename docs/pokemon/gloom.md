...
|------------|---------|--------|--------|-----------|---------|
| #44 | ![grass](../assets/types/grass.png "Grass"){: width="48"} ![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.8 m /<br>2.6 ft | 8.6 kg /<br>19.0 lbs | <span class="tooltip" title="Boosts the Pokémon’s Speed in sunshine.">Chlorophyll</span><br><span class="tooltip" title="The stench may cause the target to flinch.">Stench</span> | N/A |
