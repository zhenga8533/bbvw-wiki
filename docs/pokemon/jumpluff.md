...
|------------|---------|--------|--------|-----------|---------|
| #189 | ![grass](../assets/types/grass.png "Grass"){: width="48"} ![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.8 m /<br>2.6 ft | 3.0 kg /<br>6.6 lbs | <span class="tooltip" title="Boosts the Pokémon’s Speed in sunshine.">Chlorophyll</span><br><span class="tooltip" title="Gives priority to a status move.">Prankster</span> | N/A |
