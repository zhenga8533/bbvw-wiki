...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/articuno/front.gif "Articuno") | ![Back](../assets/sprites/articuno/back.gif "Articuno") | ![Front Shiny](../assets/sprites/articuno/front_shiny.gif "Articuno") | ![Back Shiny](../assets/sprites/articuno/back_shiny.gif "Articuno") |
...
|------------|---------|--------|--------|-----------|---------|
| #144 | ![ice](../assets/types/ice.png "Ice"){: width="48"} ![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.7 m /<br>5.6 ft | 55.4 kg /<br>122.1 lbs | <span class="tooltip" title="The Pokémon raises the foe’s PP usage.">Pressure</span><br><span class="tooltip" title="Raises evasion in a hailstorm.">Snow Cloak</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 3 Special Defense | 3 | 35 | 290 | Slow | <span class="tooltip" title="If held by a Pokémon, it raises its Sp. Atk stat in a pinch.">Petaya Berry</span> (100%) |
...
| 22 | <span class="tooltip" title="The user senses the foe’s movements with its mind to ensure its next attack does not miss.">Mind Reader</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
...
| 43 | <span class="tooltip" title="The foe is struck with an icy-cold beam of energy. It may also freeze the target solid.">Ice Beam</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 10 |
...
| 64 | <span class="tooltip" title="The user whips up a turbulent whirlwind that ups the Speed of all party Pokémon for three turns.">Tailwind</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
...
| 78 | <span class="tooltip" title="The foe is attacked with a blast of absolute-zero cold. The foe instantly faints if it hits.">Sheer Cold</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 30 | 5 |
