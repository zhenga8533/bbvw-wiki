...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/rotom-mow/official_artwork.png "Rotom Mow") | ![Shiny Artwork](../assets/sprites/rotom-mow/official_artwork_shiny.png "Rotom Mow") |
...
|-------|-------|------|-------|
| ![Rotom Mow](../assets/sprites/rotom-mow/front.gif "Rotom Mow: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Mow](../assets/sprites/rotom-mow/front_shiny.gif "Rotom Mow: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Mow](../assets/sprites/rotom-mow/back.gif "Rotom Mow: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Mow](../assets/sprites/rotom-mow/back_shiny.gif "Rotom Mow: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") |
...
| 1 | <span class="tooltip" title="The user draws power from nature and fires it at the target. It may also lower the target’s Sp. Def.">Energy Ball</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 10 |
...
Rotom Mow cannot learn any moves from tutors.
