...
|------------|---------|--------|--------|-----------|---------|
| #94 | ![ghost](../assets/types/ghost.png){: width='48'} ![poison](../assets/types/poison.png){: width='48'} | 1.5 m | 40.5 kg | 1. Levitate | #N/A |
...
| 68 | Aura Sphere | ![fighting](../assets/types/fighting.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 80 | — | 20 |
