...
| --- | --- |
| ![Official Artwork](../assets/sprites/farfetchd/official_artwork.png "Farfetchd") | ![Shiny Artwork](../assets/sprites/farfetchd/official_artwork_shiny.png "Farfetchd") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/farfetchd/front.gif "Farfetchd") | ![Back](../assets/sprites/farfetchd/back.gif "Farfetchd") | ![Front Shiny](../assets/sprites/farfetchd/front_shiny.gif "Farfetchd") | ![Back Shiny](../assets/sprites/farfetchd/back_shiny.gif "Farfetchd") |
...
| 9 | <span class="tooltip" title="The user slaps down the foe’s held item, preventing the item from being used during the battle.">Knock Off</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 65 | 100 | 20 |
...
| 19 | <span class="tooltip" title="The foe is attacked with a slash of claws, etc. It has a high critical-hit ratio.">Slash</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
...
| 35 | <span class="tooltip" title="Inflicts regular damage.  Damage calculation ignores the target's stat modifiers, including evasion.">Sacred Sword</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 100 | 15 |
| 37 | <span class="tooltip" title="Inflicts regular damage.  If the user has no held item, this move has double power.">Acrobatics</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 55 | 100 | 15 |
...
| 45 | <span class="tooltip" title="A restrained attack that prevents the foe from fainting. The target is left with at least 1 HP.">False Swipe</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 100 | 40 |
