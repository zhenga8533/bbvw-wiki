...
Latest (Gen VI+):
<p><audio controls>
  <source src='../assets/cries/577/latest.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>

Legacy:
<p><audio controls>
  <source src='../assets/cries/577/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>
...
|------------|---------|--------|--------|-----------|---------|
| #577 | ![psychic](../assets/types/psychic.png){: width='48'} | 0.3 m | 1.0 kg | 1. Regenerator<br>2. Magic-Guard | #83 |
