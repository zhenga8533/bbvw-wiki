...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/porygon2/front.gif "Porygon2") | ![Back](../assets/sprites/porygon2/back.gif "Porygon2") | ![Front Shiny](../assets/sprites/porygon2/front_shiny.gif "Porygon2") | ![Back Shiny](../assets/sprites/porygon2/back_shiny.gif "Porygon2") |
...
| 34 | <span class="tooltip" title="The user recycles a single-use item that has been used in battle so it can be used again.">Recycle</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
