...
| --- | --- |
| ![Official Artwork](../assets/sprites/seviper/official_artwork.png "Seviper") | ![Shiny Artwork](../assets/sprites/seviper/official_artwork_shiny.png "Seviper") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/seviper/front.gif "Seviper") | ![Back](../assets/sprites/seviper/back.gif "Seviper") | ![Front Shiny](../assets/sprites/seviper/front_shiny.gif "Seviper") | ![Back Shiny](../assets/sprites/seviper/back_shiny.gif "Seviper") |
...
| 16 | <span class="tooltip" title="An attack with a high critical-hit ratio. This tail  attack may also  poison the foe.">Poison Tail</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 100 | 15 |
...
| 25 | <span class="tooltip" title="The user intimidates the foe with the pattern on its belly to cause paralysis. ">Glare</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 30 |
...
| 37 | <span class="tooltip" title="The user enrages the foe into confusion. However, it also sharply raises the foe’s Attack stat.">Swagger</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 85 | 15 |
...
| 46 | <span class="tooltip" title="The user slashes the foe the instant an opportunity arises. It has a high critical-hit ratio.">Night Slash</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
| 52 | <span class="tooltip" title="The foe is stabbed with a tentacle or arm steeped in poison. It may also poison the foe.">Poison Jab</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 20 |
| 55 | <span class="tooltip" title="Inflicts regular damage.  If the target is poisoned, this move has double power.">Venoshock</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
...
| 64 | <span class="tooltip" title="Raises the user's Attack, Defense, and accuracy by one stage each.">Coil</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 67 | <span class="tooltip" title="The user shoots filthy garbage at the foe to attack. It may also poison the target.">Gunk Shot</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 80 | 5 |
...
| <span class="tooltip" title="Inflicts damage equal to the user's remaining HP.  User faints.">Final Gambit</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 100 | 5 |
