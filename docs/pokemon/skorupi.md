...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/skorupi/official_artwork.png "Skorupi") | ![Shiny Artwork](../assets/sprites/skorupi/official_artwork_shiny.png "Skorupi") |
...
|-------|-------|------|-------|
| ![Skorupi](../assets/sprites/skorupi/front.gif "Skorupi: As soon as the tail claws close, its needle tips secrete poison. It can survive a year without food.") | ![Skorupi](../assets/sprites/skorupi/front_shiny.gif "Skorupi: As soon as the tail claws close, its needle tips secrete poison. It can survive a year without food.") | ![Skorupi](../assets/sprites/skorupi/back.gif "Skorupi: As soon as the tail claws close, its needle tips secrete poison. It can survive a year without food.") | ![Skorupi](../assets/sprites/skorupi/back_shiny.gif "Skorupi: As soon as the tail claws close, its needle tips secrete poison. It can survive a year without food.") |
...
|------------|---------|--------|--------|-----------|---------|
| #451 | ![poison](../assets/types/poison.png "Poison"){: width="48"}<br>![bug](../assets/types/bug.png "Bug"){: width="48"} | 0.8 m /<br>2.6 ft | 12.0 kg /<br>26.5 lbs | 1. <span class="tooltip" title="The Pokémon is protected against critical hits.">Battle Armor</span><br>2. <span class="tooltip" title="Powers up moves if they become critical hits.">Sniper</span> | #127 |
...
| 6 | <span class="tooltip" title="The user slaps down the target’s held item, preventing that item from being used in the battle.">Knock Off</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 65 | 100 | 20 |
...
| 17 | <span class="tooltip" title="The user applies pressure to stress points, sharply boosting one of its stats.">Acupressure</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 30 |
| 23 | <span class="tooltip" title="The user frightens the target with a scary face to harshly reduce its Speed stat.">Scary Face</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 10 |
...
| 34 | <span class="tooltip" title="The user bites the target. If the target is holding a Berry, the user eats it and gains its effect.">Bug Bite</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 20 |
| 39 | <span class="tooltip" title="The user bites the target with toxic fangs. It may also leave the target badly poisoned.">Poison Fang</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 65 | 95 | 15 |
| 45 | <span class="tooltip" title="The user sharpens its claws to boost its Attack stat and accuracy.">Hone Claws</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
| 50 | <span class="tooltip" title="The user drenches the target in a special poisonous liquid. Its power is doubled if the target is poisoned.">Venoshock</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
...
| 61 | <span class="tooltip" title="A slashing attack with a poisonous blade that may also leave the target poisoned. Critical hits land more easily.">Cross Poison</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 100 | 15 |
...
| <span class="tooltip" title="The user damages the target twice in succession by jabbing it with two spikes. It may also poison the target.">Twineedle</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 25 | 100 | 20 |
...
| <span class="tooltip" title="The user hits the target with its tail. It may also poison the target. Critical hits land more easily.">Poison Tail</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 100 | 15 |
