...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/bellossom/front.gif "Bellossom") | ![Back](../assets/sprites/bellossom/back.gif "Bellossom") | ![Front Shiny](../assets/sprites/bellossom/front_shiny.gif "Bellossom") | ![Back Shiny](../assets/sprites/bellossom/back_shiny.gif "Bellossom") |
...
| 38 | <span class="tooltip" title="Raises the user's Special Attack, Special Defense, and Speed by one stage each.">Quiver Dance</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
