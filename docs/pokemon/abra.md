...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/abra/front.gif "Abra") | ![Back](../assets/sprites/abra/back.gif "Abra") | ![Front Shiny](../assets/sprites/abra/front_shiny.gif "Abra") | ![Back Shiny](../assets/sprites/abra/back_shiny.gif "Abra") |
...
|------------|---------|--------|--------|-----------|---------|
| #63 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 0.9 m /<br>3.0 ft | 19.5 kg /<br>43.0 lbs |  | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br>2. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | N/A |
