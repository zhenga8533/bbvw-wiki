...
| --- | --- |
| ![Official Artwork](../assets/sprites/roserade/official_artwork.png "Roserade") | ![Shiny Artwork](../assets/sprites/roserade/official_artwork_shiny.png "Roserade") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/roserade/front.gif "Roserade") | ![Back](../assets/sprites/roserade/back.gif "Roserade") | ![Front Shiny](../assets/sprites/roserade/front_shiny.gif "Roserade") | ![Back Shiny](../assets/sprites/roserade/back_shiny.gif "Roserade") |

### Female Sprites

| Front | Back | Front Shiny | Back Shiny |
| --- | --- | --- | --- |
| ![Front](../assets/sprites/roserade/front_female.gif "Roserade") | ![Back](../assets/sprites/roserade/back_female.gif "Roserade") | ![Front Shiny](../assets/sprites/roserade/front_shiny_female.gif "Roserade") | ![Back Shiny](../assets/sprites/roserade/back_shiny_female.gif "Roserade") |
...
|------------|---------|--------|--------|-----------|---------|
| #407 | ![grass](../assets/types/grass.png "Grass"){: width="48"}<br>![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.9 m /<br>3.0 ft | 14.5 kg /<br>32.0 lbs |  | 1. <span class="tooltip" title="All status problems heal when it switches out.">Natural Cure</span><br>2. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span> | N/A |
...
| 55 | <span class="tooltip" title="The user attacks by scattering petals for two to three turns. The user then becomes confused.">Petal Dance</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 120 | 100 | 10 |
