...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/slowbro/official_artwork.png "Slowbro") | ![Shiny Artwork](../assets/sprites/slowbro/official_artwork_shiny.png "Slowbro") |
...
|-------|-------|------|-------|
| ![Slowbro](../assets/sprites/slowbro/front.gif "Slowbro: Though usually dim witted, it seems to become inspired if the Shellder on its tail bites down.") | ![Slowbro](../assets/sprites/slowbro/front_shiny.gif "Slowbro: Though usually dim witted, it seems to become inspired if the Shellder on its tail bites down.") | ![Slowbro](../assets/sprites/slowbro/back.gif "Slowbro: Though usually dim witted, it seems to become inspired if the Shellder on its tail bites down.") | ![Slowbro](../assets/sprites/slowbro/back_shiny.gif "Slowbro: Though usually dim witted, it seems to become inspired if the Shellder on its tail bites down.") |
...
|------------|---------|--------|--------|-----------|---------|
| #80 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 1.6 m /<br>5.2 ft | 78.5 kg /<br>173.1 lbs | 1. <span class="tooltip" title="Restores a little HP when withdrawn from battle.">Regenerator</span><br>2. <span class="tooltip" title="The Pokémon makes it rain if it appears in battle.">Drizzle</span> | N/A |
...
| 21 | <span class="tooltip" title="The user shoots boiling hot water at its target. It may also leave the target with a burn.">Scald</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 15 |
| 23 | <span class="tooltip" title="The user sticks out its head and attacks by charging straight into the target. It may also make the target flinch.">Headbutt</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
...
| 49 | <span class="tooltip" title="The target is hit by a strong telekinetic force. It may also reduce the target’s Sp. Def stat.">Psychic</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 10 |
...
Slowbro cannot learn any moves from tutors.
