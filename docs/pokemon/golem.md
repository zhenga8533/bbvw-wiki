...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/golem/front.gif "Golem") | ![Back](../assets/sprites/golem/back.gif "Golem") | ![Front Shiny](../assets/sprites/golem/front_shiny.gif "Golem") | ![Back Shiny](../assets/sprites/golem/back_shiny.gif "Golem") |
...
|------------|---------|--------|--------|-----------|---------|
| #76 | ![rock](../assets/types/rock.png "Rock"){: width="48"}<br>![ground](../assets/types/ground.png "Ground"){: width="48"} | 1.4 m /<br>4.6 ft | 300.0 kg /<br>661.4 lbs |  | 1. <span class="tooltip" title="Protects the Pokémon from recoil damage.">Rock Head</span><br>2. <span class="tooltip" title="It cannot be knocked out with one hit.">Sturdy</span> | N/A |
...
| 36 | <span class="tooltip" title="Inflicts regular damage.  Has a 30% chance to make the target flinch.  Power is doubled against Pokémon that have used minimize since entering the field.">Steamroller</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 20 |
