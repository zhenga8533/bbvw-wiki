...
| --- | --- |
| ![Official Artwork](../assets/sprites/krookodile/official_artwork.png "Krookodile") | ![Shiny Artwork](../assets/sprites/krookodile/official_artwork_shiny.png "Krookodile") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/krookodile/front.gif "Krookodile") | ![Back](../assets/sprites/krookodile/back.gif "Krookodile") | ![Front Shiny](../assets/sprites/krookodile/front_shiny.gif "Krookodile") | ![Back Shiny](../assets/sprites/krookodile/back_shiny.gif "Krookodile") |
...
|------------|---------|--------|--------|-----------|---------|
| #553 | ![ground](../assets/types/ground.png "Ground"){: width="48"} ![dark](../assets/types/dark.png "Dark"){: width="48"} | 1.5 m /<br>4.9 ft | 96.3 kg /<br>212.3 lbs | <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span><br><span class="tooltip" title="Boosts Attack after knocking out any Pokémon.">Moxie</span> | #59 |
...
| 16 | <span class="tooltip" title="If the foe has already taken some damage in the same turn, this attack’s power is doubled.">Assurance</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 10 |
...
| 42 | <span class="tooltip" title="Inflicts regular damage.  Damage is calculated using the target's attacking stat rather than the user's.">Foul Play</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 95 | 100 | 15 |
| 48 | <span class="tooltip" title="A five-turn sand­ storm is summoned to hurt all combatant types except Rock,  Ground, and Steel.">Sandstorm</span> | ![rock](../assets/types/rock.png "Rock"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
...
| 66 | <span class="tooltip" title="This move enables the user to attack first. It fails if the foe is not readying an attack, however.">Sucker Punch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
