...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/gorebyss/official_artwork.png "Gorebyss") | ![Shiny Artwork](../assets/sprites/gorebyss/official_artwork_shiny.png "Gorebyss") |
...
|-------|-------|------|-------|
| ![Gorebyss](../assets/sprites/gorebyss/front.gif "Gorebyss: It lives at the bottom of the sea. In the springtime, its pink body turns more vivid for some reason.") | ![Gorebyss](../assets/sprites/gorebyss/front_shiny.gif "Gorebyss: It lives at the bottom of the sea. In the springtime, its pink body turns more vivid for some reason.") | ![Gorebyss](../assets/sprites/gorebyss/back.gif "Gorebyss: It lives at the bottom of the sea. In the springtime, its pink body turns more vivid for some reason.") | ![Gorebyss](../assets/sprites/gorebyss/back_shiny.gif "Gorebyss: It lives at the bottom of the sea. In the springtime, its pink body turns more vivid for some reason.") |
...
|------------|---------|--------|--------|-----------|---------|
| #368 | ![water](../assets/types/water.png "Water"){: width="48"} | 1.8 m /<br>5.9 ft | 22.6 kg /<br>49.8 lbs | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in rain.">Swift Swim</span><br>2. <span class="tooltip" title="Draws in all Water-type moves to up Sp. Attack.">Storm Drain</span> | N/A |
...
| 28 | <span class="tooltip" title="If it is the opposite gender of the user, the target is charmed into harshly lowering its Sp. Atk stat.">Captivate</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
