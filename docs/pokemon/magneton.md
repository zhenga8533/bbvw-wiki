...
|------------|---------|--------|--------|-----------|---------|
| #82 | ![electric](../assets/types/electric.png){: width='48'} ![steel](../assets/types/steel.png){: width='48'} | 1.0 m /<br>3.3 ft | 60.0 kg /<br>132.3 lbs | <span class="tooltip" title="Prevents Steel-type Pokémon from escaping.">Magnet Pull</span><br><span class="tooltip" title="Boosts move power when the Pokémon moves last.">Analytic</span> | N/A |
...
| 30 | <span class="tooltip" title="The user strikes with a simultaneous three- beam attack. May also paralyze, burn, or freeze the target.">Tri Attack</span> | ![normal](../assets/types/normal.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 80 | 100 | 10 |
