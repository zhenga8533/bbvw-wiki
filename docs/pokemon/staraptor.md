...
| --- | --- |
| ![Official Artwork](../assets/sprites/staraptor/official_artwork.png "Staraptor") | ![Shiny Artwork](../assets/sprites/staraptor/official_artwork_shiny.png "Staraptor") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/staraptor/front.gif "Staraptor") | ![Back](../assets/sprites/staraptor/back.gif "Staraptor") | ![Front Shiny](../assets/sprites/staraptor/front_shiny.gif "Staraptor") | ![Back Shiny](../assets/sprites/staraptor/back_shiny.gif "Staraptor") |

### Female Sprites

| Front | Back | Front Shiny | Back Shiny |
| --- | --- | --- | --- |
| ![Front](../assets/sprites/staraptor/front_female.gif "Staraptor") | ![Back](../assets/sprites/staraptor/back_female.gif "Staraptor") | ![Front Shiny](../assets/sprites/staraptor/front_shiny_female.gif "Staraptor") | ![Back Shiny](../assets/sprites/staraptor/back_shiny_female.gif "Staraptor") |
...
| 18 | <span class="tooltip" title="An attack move that cuts down the foe’s HP to equal the user’s HP. ">Endeavor</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 5 |
| 23 | <span class="tooltip" title="The foe is blown away, to be replaced by another Pokémon in its party. In the wild, the battle ends.">Whirlwind</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 28 | <span class="tooltip" title="The user confounds the foe with speed, then slashes. The attack lands without fail.">Aerial Ace</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | — | 20 |
