...
|------------|---------|--------|--------|-----------|---------|
| #417 | ![electric](../assets/types/electric.png "Electric"){: width="48"} | 0.4 m /<br>1.3 ft | 3.9 kg /<br>8.6 lbs |  | 1. <span class="tooltip" title="Restores HP if hit by an Electric-type move.">Volt Absorb</span><br>2. <span class="tooltip" title="The Pokémon may pick up items.">Pickup</span> | N/A |
