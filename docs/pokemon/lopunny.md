...
|-------|-------|------|-------|
| ![Lopunny](../assets/sprites/lopunny/front.gif "Lopunny: The ears appear to be delicate. If they are touched roughly, it kicks with its graceful legs.") | ![Lopunny](../assets/sprites/lopunny/front_shiny.gif "Lopunny: The ears appear to be delicate. If they are touched roughly, it kicks with its graceful legs.") | ![Lopunny](../assets/sprites/lopunny/back.gif "Lopunny: The ears appear to be delicate. If they are touched roughly, it kicks with its graceful legs.") | ![Lopunny](../assets/sprites/lopunny/back_shiny.gif "Lopunny: The ears appear to be delicate. If they are touched roughly, it kicks with its graceful legs.") |
...
|------------|---------|--------|--------|-----------|---------|
| #428 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 1.2 m /<br>3.9 ft | 33.3 kg /<br>73.4 lbs | 1. <span class="tooltip" title="Contact with the Pokémon may cause infatuation.">Cute Charm</span><br>2. <span class="tooltip" title="The Pokémon is protected from paralysis.">Limber</span> | #68 |
