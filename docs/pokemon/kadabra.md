...
|------------|---------|--------|--------|-----------|---------|
| #64 | ![psychic](../assets/types/psychic.png){: width='48'} | 1.3 m /<br>4.3 ft | 56.5 kg /<br>124.6 lbs | <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br><span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | N/A |
...
| 42 | <span class="tooltip" title="The user mimics the foe completely, copying the foe’s natural ability. ">Role Play</span> | ![psychic](../assets/types/psychic.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 10 |
