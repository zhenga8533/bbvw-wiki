...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/tentacruel/official_artwork.png "Tentacruel") | ![Shiny Artwork](../assets/sprites/tentacruel/official_artwork_shiny.png "Tentacruel") |
...
|-------|-------|------|-------|
| ![Tentacruel](../assets/sprites/tentacruel/front.gif "Tentacruel: It extends its 80 tentacles to form an encircling poisonous net that is difficult to escape.") | ![Tentacruel](../assets/sprites/tentacruel/front_shiny.gif "Tentacruel: It extends its 80 tentacles to form an encircling poisonous net that is difficult to escape.") | ![Tentacruel](../assets/sprites/tentacruel/back.gif "Tentacruel: It extends its 80 tentacles to form an encircling poisonous net that is difficult to escape.") | ![Tentacruel](../assets/sprites/tentacruel/back_shiny.gif "Tentacruel: It extends its 80 tentacles to form an encircling poisonous net that is difficult to escape.") |
...
| 12 | <span class="tooltip" title="The opposing team is attacked with a spray of harsh acid. The acid may also lower the targets’ Sp. Def stats.">Acid</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 30 |
| 15 | <span class="tooltip" title="The user lays a trap of poison spikes at the opponent’s feet. They poison opponents that switch into battle.">Toxic Spikes</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 22 | <span class="tooltip" title="A long body or vines are used to wrap and squeeze the target for four to five turns.">Wrap</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 15 | 90 | 20 |
| 26 | <span class="tooltip" title="The user spits fluid that works to melt the target. This harshly reduces the target’s Sp. Def stat.">Acid Spray</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 20 |
| 29 | <span class="tooltip" title="The user throws up a sturdy wall that sharply raises its Defense stat.">Barrier</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 34 | <span class="tooltip" title="The user attacks the target with a pulsing blast of water. It may also confuse the target.">Water Pulse</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 60 | 100 | 20 |
| 38 | <span class="tooltip" title="The target is stabbed with a tentacle or arm steeped in poison. It may also poison the target.">Poison Jab</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 20 |
| 43 | <span class="tooltip" title="An earsplitting screech harshly reduces the target’s Defense stat.">Screech</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 85 | 40 |
| 47 | <span class="tooltip" title="This relentless attack does massive damage to a target affected by status problems.">Hex</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
...
| 56 | <span class="tooltip" title="It swamps the area around the user with a giant sludge wave. It may also poison those hit.">Sludge Wave</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 95 | 100 | 10 |
| 61 | <span class="tooltip" title="The user powerfully wrings the target. The more HP the target has, the greater this attack’s power.">Wring Out</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 100 | 5 |
| 66 | <span class="tooltip" title="The user applies pressure to stress points, sharply boosting one of its stats.">Acupressure</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 30 |
