...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/chandelure/front.gif "Chandelure") | ![Back](../assets/sprites/chandelure/back.gif "Chandelure") | ![Front Shiny](../assets/sprites/chandelure/front_shiny.gif "Chandelure") | ![Back Shiny](../assets/sprites/chandelure/back_shiny.gif "Chandelure") |
...
|------------|---------|--------|--------|-----------|---------|
| #609 | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"}<br>![fire](../assets/types/fire.png "Fire"){: width="48"} | 1.0 m /<br>3.3 ft | 34.3 kg /<br>75.6 lbs |  | 1. <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span> | #115 |
...
| 1 | <span class="tooltip" title="Inflicts regular damage.  If the target has a major status ailment, this move has double power.">Hex</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
