...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/bellsprout/front.gif "Bellsprout") | ![Back](../assets/sprites/bellsprout/back.gif "Bellsprout") | ![Front Shiny](../assets/sprites/bellsprout/front_shiny.gif "Bellsprout") | ![Back Shiny](../assets/sprites/bellsprout/back_shiny.gif "Bellsprout") |
...
| 3 | <span class="tooltip" title="The user kisses the foe with a sweet, angelic cuteness that causes confusion. ">Sweet Kiss</span> | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 75 | 10 |
| 5 | <span class="tooltip" title="With a scary face, the user forces a kiss on the foe. It may make the target fall asleep.">Lovely Kiss</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 75 | 10 |
...
| 9 | <span class="tooltip" title="A blood-draining attack. The user’s HP is restored by half the damage taken by the target.">Leech Life</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 10 |
| 11 | <span class="tooltip" title="A long body or vines are used to wrap and squeeze the foe for two to five turns. ">Wrap</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 15 | 90 | 20 |
...
| 17 | <span class="tooltip" title="The user scatters a cloud of paralyzing powder. It may paralyze the target.">Stun Spore</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 75 | 30 |
...
| 21 | <span class="tooltip" title="Inflicts regular damage.  All of the target's stat modifiers are reset to zero.">Clear Smog</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 50 | — | 15 |
| 23 | <span class="tooltip" title="The foe is attacked with a spray of harsh acid. It may also lower the target’s Sp. Def stat.">Acid</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 30 |
...
| 29 | <span class="tooltip" title="A sweet scent that lowers the foe’s evasiveness. It also lures wild Pokémon if used in grass, etc.">Sweet Scent</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
...
| 41 | <span class="tooltip" title="The foe is slammed with a long tail, vines, etc., to inflict damage. ">Slam</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 75 | 20 |
