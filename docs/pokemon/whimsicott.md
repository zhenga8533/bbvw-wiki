...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/whimsicott/front.gif "Whimsicott") | ![Back](../assets/sprites/whimsicott/back.gif "Whimsicott") | ![Front Shiny](../assets/sprites/whimsicott/front_shiny.gif "Whimsicott") | ![Back Shiny](../assets/sprites/whimsicott/back_shiny.gif "Whimsicott") |
...
|------------|---------|--------|--------|-----------|---------|
| #547 | ![grass](../assets/types/grass.png "Grass"){: width="48"} ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.7 m /<br>2.3 ft | 6.6 kg /<br>14.6 lbs | <span class="tooltip" title="Gives priority to a status move.">Prankster</span><br><span class="tooltip" title="Passes through the foe’s barrier and strikes.">Infiltrator</span> | #53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | <span class="tooltip" title="The user releases cottonlike spores that cling to the foe, sharply reducing its Speed stat.">Cotton Spore</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 40 |
...
| 28 | <span class="tooltip" title="The user whips up a turbulent whirlwind that ups the Speed of all party Pokémon for three turns.">Tailwind</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
...
| 64 | <span class="tooltip" title="The user plays a pleasant melody that lulls the foe into a deep sleep. ">Grass Whistle</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 55 | 15 |
