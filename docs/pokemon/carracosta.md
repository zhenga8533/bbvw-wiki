...
|------------|---------|--------|--------|-----------|---------|
| #565 | ![water](../assets/types/water.png){: width='48'} ![rock](../assets/types/rock.png){: width='48'} | 1.2 m /<br>3.9 ft | 81.0 kg /<br>178.6 lbs | <span class="tooltip" title="Reduces damage from supereffective attacks.">Solid Rock</span><br><span class="tooltip" title="It cannot be knocked out with one hit.">Sturdy</span> | #71 |
...
| 40 | <span class="tooltip" title="Raises the user's Attack, Special Attack, and Speed by two stages each.  Lowers the user's Defense and Special Defense by one stage each.">Shell Smash</span> | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 15 |
...
| 56 | <span class="tooltip" title="The user summons a heavy rain that falls for five turns, powering up Water- type moves.">Rain Dance</span> | ![water](../assets/types/water.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 5 |
