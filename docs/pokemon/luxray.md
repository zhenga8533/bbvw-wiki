...
|------------|---------|--------|--------|-----------|---------|
| #405 | ![electric](../assets/types/electric.png "Electric"){: width="48"} ![dark](../assets/types/dark.png "Dark"){: width="48"} | 1.4 m /<br>4.6 ft | 42.0 kg /<br>92.6 lbs | <span class="tooltip" title="Boosts Attack if there is a status problem.">Guts</span><br><span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span> | N/A |
