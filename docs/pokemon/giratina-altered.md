...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/giratina-altered/front.gif "Giratina Altered") | ![Back](../assets/sprites/giratina-altered/back.gif "Giratina Altered") | ![Front Shiny](../assets/sprites/giratina-altered/front_shiny.gif "Giratina Altered") | ![Back Shiny](../assets/sprites/giratina-altered/back_shiny.gif "Giratina Altered") |
...
| 15 | <span class="tooltip" title="The foe is attacked with a slash of claws, etc. It has a high critical-hit ratio.">Slash</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
...
| 24 | <span class="tooltip" title="When this move is used, if the user faints, the foe that landed the knockout hit also faints.">Destiny Bond</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
...
| 42 | <span class="tooltip" title="The user slashes with a sharp claw made from shadows. It has a high critical-hit ratio.">Shadow Claw</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
| 46 | <span class="tooltip" title="The user disappears, then strikes the foe on the second turn. It hits even if the foe used Protect.">Shadow Force</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 5 |
