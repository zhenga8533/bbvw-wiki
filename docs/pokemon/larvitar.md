...
|------------|---------|--------|--------|-----------|---------|
| #246 | ![rock](../assets/types/rock.png "Rock"){: width="48"} ![ground](../assets/types/ground.png "Ground"){: width="48"} | 0.6 m /<br>2.0 ft | 72.0 kg /<br>158.7 lbs | <span class="tooltip" title="Boosts Attack if there is a status problem.">Guts</span><br><span class="tooltip" title="Boosts the Attack stat, but lowers accuracy.">Hustle</span> | N/A |
