...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/cloyster/front.gif "Cloyster") | ![Back](../assets/sprites/cloyster/back.gif "Cloyster") | ![Front Shiny](../assets/sprites/cloyster/front_shiny.gif "Cloyster") | ![Back Shiny](../assets/sprites/cloyster/back_shiny.gif "Cloyster") |
...
| 13 | <span class="tooltip" title="Sharp spikes are fired at the foe to strike two to five times in rapid succession.">Spike Cannon</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 25 | 100 | 15 |
...
| 63 | <span class="tooltip" title="Raises the user's Attack, Special Attack, and Speed by two stages each.  Lowers the user's Defense and Special Defense by one stage each.">Shell Smash</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
