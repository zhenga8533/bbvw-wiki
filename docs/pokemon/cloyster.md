...
|------------|---------|--------|--------|-----------|---------|
| #91 | ![water](../assets/types/water.png "Water"){: width="48"} ![ice](../assets/types/ice.png "Ice"){: width="48"} | 1.5 m /<br>4.9 ft | 132.5 kg /<br>292.1 lbs | <span class="tooltip" title="Protects the Pokémon from damage from weather.">Overcoat</span><br><span class="tooltip" title="Increases the frequency of multi-strike moves.">Skill Link</span> | N/A |
