...
|------------|---------|--------|--------|-----------|---------|
| #10100 | ![electric](../assets/types/electric.png){: width='48'} ![psychic](../assets/types/psychic.png){: width='48'} | 0.7 m | 21.0 kg | 1. Surge-Surfer | #N/A |
...
|-----|------|------|------|-------|------|----|
| 0 | Psychic | ![psychic](../assets/types/psychic.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 90 | 100 | 10 |
| 1 | Psychic | ![psychic](../assets/types/psychic.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 90 | 100 | 10 |
| 1 | Quick Attack | ![normal](../assets/types/normal.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 40 | 100 | 30 |
| 1 | Speed Swap | ![psychic](../assets/types/psychic.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 10 |
