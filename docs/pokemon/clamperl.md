...
|------------|---------|--------|--------|-----------|---------|
| #366 | ![water](../assets/types/water.png){: width='48'} | 0.4 m /<br>1.3 ft | 52.5 kg /<br>115.7 lbs | <span class="tooltip" title="The Pokémon is protected against critical hits.">Shell Armor</span><br><span class="tooltip" title="Some move types scare it and boost its Speed.">Rattled</span> | N/A |
...
1. Huntail: Level Up at Night with a Deep Sea Tooth equipped.
2. Gorebyss: Level Up at Night with a Deep Sea Scale equipped.
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | <span class="tooltip" title="The foe is clamped and squeezed by the user’s very thick and sturdy shell for two to five turns.">Clamp</span> | ![water](../assets/types/water.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 35 | 85 | 15 |
...
| 1 | <span class="tooltip" title="The user traps the foe inside a fast, vicious whirlpool that lasts for two to five turns.">Whirlpool</span> | ![water](../assets/types/water.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 35 | 85 | 15 |
| 25 | <span class="tooltip" title="The user attacks by shooting out muddy water. It may also lower the foe’s accuracy.">Muddy Water</span> | ![water](../assets/types/water.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 90 | 85 | 10 |
| 30 | <span class="tooltip" title="The user throws up a sturdy wall that sharply raises its Defense stat. ">Barrier</span> | ![psychic](../assets/types/psychic.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 20 |
| 35 | <span class="tooltip" title="Raises the user's Attack, Special Attack, and Speed by two stages each.  Lowers the user's Defense and Special Defense by one stage each.">Shell Smash</span> | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 15 |
