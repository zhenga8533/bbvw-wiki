...
| --- | --- |
| ![Official Artwork](../assets/sprites/volbeat/official_artwork.png "Volbeat") | ![Shiny Artwork](../assets/sprites/volbeat/official_artwork_shiny.png "Volbeat") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/volbeat/front.gif "Volbeat") | ![Back](../assets/sprites/volbeat/back.gif "Volbeat") | ![Front Shiny](../assets/sprites/volbeat/front_shiny.gif "Volbeat") | ![Back Shiny](../assets/sprites/volbeat/back_shiny.gif "Volbeat") |
...
|------------|---------|--------|--------|-----------|---------|
| #313 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![electric](../assets/types/electric.png "Electric"){: width="48"} | 0.7 m /<br>2.3 ft | 17.7 kg /<br>39.0 lbs |  | 1. <span class="tooltip" title="Gives priority to a status move.">Prankster</span><br>2. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span> | N/A |
...
| 15 | <span class="tooltip" title="A jolt of electricity is hurled at the foe to inflict damage. It may also leave the foe paralyzed.">Thunder Shock</span> | ![electric](../assets/types/electric.png "Electric"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 30 |
...
| 19 | <span class="tooltip" title="Inflicts regular damage.  Has a 100% chance to lower the target's Special Attack by one stage.">Struggle Bug</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 50 | 100 | 20 |
| 21 | <span class="tooltip" title="The user stares at flashing lights to focus its mind, sharply raising its Sp. Atk stat.">Tail Glow</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 23 | <span class="tooltip" title="The user strikes the foe with a quick jolt of electricity. This attack cannot be evaded.">Shock Wave</span> | ![electric](../assets/types/electric.png "Electric"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 70 | — | 20 |
...
| 49 | <span class="tooltip" title="The user switches places with a party Pokémon in waiting, passing along any stat changes.">Baton Pass</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 40 |
| 53 | <span class="tooltip" title="The user whips up a turbulent whirlwind that ups the Speed of all party Pokémon for three turns.">Tailwind</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
