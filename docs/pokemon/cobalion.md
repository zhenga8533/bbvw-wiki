...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/cobalion/official_artwork.png "Cobalion") | ![Shiny Artwork](../assets/sprites/cobalion/official_artwork_shiny.png "Cobalion") |
...
|-------|-------|------|-------|
| ![Cobalion](../assets/sprites/cobalion/front.gif "Cobalion: It has a body and heart of steel. Its glare is sufficient to make even an unruly Pokémon obey it.") | ![Cobalion](../assets/sprites/cobalion/front_shiny.gif "Cobalion: It has a body and heart of steel. Its glare is sufficient to make even an unruly Pokémon obey it.") | ![Cobalion](../assets/sprites/cobalion/back.gif "Cobalion: It has a body and heart of steel. Its glare is sufficient to make even an unruly Pokémon obey it.") | ![Cobalion](../assets/sprites/cobalion/back_shiny.gif "Cobalion: It has a body and heart of steel. Its glare is sufficient to make even an unruly Pokémon obey it.") |
...
|------------|---------|--------|--------|-----------|---------|
| #638 | ![steel](../assets/types/steel.png "Steel"){: width="48"}<br>![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | 2.1 m /<br>6.9 ft | 250.0 kg /<br>551.2 lbs | 1. <span class="tooltip" title="Raises Attack when hit by a Dark-type move.">Justified</span> | N/A |
...
| 13 | <span class="tooltip" title="The target is raked with steel claws. It may also raise the user’s Attack stat.">Metal Claw</span> | ![steel](../assets/types/steel.png "Steel"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 95 | 35 |
...
| 67 | <span class="tooltip" title="The user retaliates with much greater power against the target that last inflicted damage on it.">Metal Burst</span> | ![steel](../assets/types/steel.png "Steel"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 10 |
