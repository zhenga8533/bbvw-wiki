...
| --- | --- |
| ![Official Artwork](../assets/sprites/jellicent/official_artwork.png "Jellicent") | ![Shiny Artwork](../assets/sprites/jellicent/official_artwork_shiny.png "Jellicent") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/jellicent/front.gif "Jellicent") | ![Back](../assets/sprites/jellicent/back.gif "Jellicent") | ![Front Shiny](../assets/sprites/jellicent/front_shiny.gif "Jellicent") | ![Back Shiny](../assets/sprites/jellicent/back_shiny.gif "Jellicent") |

### Female Sprites

| Front | Back | Front Shiny | Back Shiny |
| --- | --- | --- | --- |
| ![Front](../assets/sprites/jellicent/front_female.gif "Jellicent") | ![Back](../assets/sprites/jellicent/back_female.gif "Jellicent") | ![Front Shiny](../assets/sprites/jellicent/front_shiny_female.gif "Jellicent") | ![Back Shiny](../assets/sprites/jellicent/back_shiny_female.gif "Jellicent") |
...
|------------|---------|--------|--------|-----------|---------|
| #593 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | 2.2 m /<br>7.2 ft | 135.0 kg /<br>297.6 lbs |  | 1. <span class="tooltip" title="Restores HP if hit by a Water-type move.">Water Absorb</span><br>2. <span class="tooltip" title="May disable a move used on the Pokémon.">Cursed Body</span> | #99 |
...
| 45 | <span class="tooltip" title="Inflicts regular damage.  If the target has a major status ailment, this move has double power.">Hex</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
...
| 69 | <span class="tooltip" title="The user spouts water to damage the foe. The lower the user’s HP, the less powerful it becomes.">Water Spout</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 150 | 100 | 5 |
