...
| --- | --- |
| ![Official Artwork](../assets/sprites/zigzagoon/official_artwork.png "Zigzagoon") | ![Shiny Artwork](../assets/sprites/zigzagoon/official_artwork_shiny.png "Zigzagoon") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/zigzagoon/front.gif "Zigzagoon") | ![Back](../assets/sprites/zigzagoon/back.gif "Zigzagoon") | ![Front Shiny](../assets/sprites/zigzagoon/front_shiny.gif "Zigzagoon") | ![Back Shiny](../assets/sprites/zigzagoon/back_shiny.gif "Zigzagoon") |
...
|------------|---------|--------|--------|-----------|---------|
| #263 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.4 m /<br>1.3 ft | 17.5 kg /<br>38.6 lbs | <span class="tooltip" title="The Pokémon may pick up items.">Pickup</span><br><span class="tooltip" title="Encourages the early use of a held Berry.">Gluttony</span> | N/A |
...
| 21 | <span class="tooltip" title="The user covers itself with mud. It weakens Electric- type moves while the user is in the battle.">Mud Sport</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
| 25 | <span class="tooltip" title="Sharp pins are shot at the foe in rapid succession. They hit two to five times in a row.">Pin Missile</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 25 | 95 | 20 |
| 29 | <span class="tooltip" title="The user endearingly approaches the foe, then steals the item the foe is holding. ">Covet</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 25 |
| 33 | <span class="tooltip" title="Transfers the user's held item to the target.  If the user has no held item, or the target already has a held item, this move will fail.">Bestow</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
...
| 41 | <span class="tooltip" title="The user goes to sleep for two turns. It fully restores the user’s HP and heals any status problem.">Rest</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
| 45 | <span class="tooltip" title="The user maximizes its Attack stat in exchange for HP equal to half its max HP.">Belly Drum</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
| 49 | <span class="tooltip" title="The user flings its held item at the foe to attack. Its power and effects depend on the item.">Fling</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 10 |
...
| <span class="tooltip" title="Changes the target's ability to simple.">Simple Beam</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
