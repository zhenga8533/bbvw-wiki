...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/tyrogue/official_artwork.png "Tyrogue") | ![Shiny Artwork](../assets/sprites/tyrogue/official_artwork_shiny.png "Tyrogue") |
...
|-------|-------|------|-------|
| ![Tyrogue](../assets/sprites/tyrogue/front.gif "Tyrogue: It is famous for its eagerness to fight and always nurses injuries from challenging larger foes.") | ![Tyrogue](../assets/sprites/tyrogue/front_shiny.gif "Tyrogue: It is famous for its eagerness to fight and always nurses injuries from challenging larger foes.") | ![Tyrogue](../assets/sprites/tyrogue/back.gif "Tyrogue: It is famous for its eagerness to fight and always nurses injuries from challenging larger foes.") | ![Tyrogue](../assets/sprites/tyrogue/back_shiny.gif "Tyrogue: It is famous for its eagerness to fight and always nurses injuries from challenging larger foes.") |
...
| <span class="tooltip" title="The target is attacked with a knee kick from a jump. If it misses, the user is hurt instead.">High Jump Kick</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 130 | 90 | 10 |
