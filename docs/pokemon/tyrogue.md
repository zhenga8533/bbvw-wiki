...
Latest (Gen VI+):
<p><audio controls>
  <source src='../assets/cries/236/latest.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>

Legacy:
<p><audio controls>
  <source src='../assets/cries/236/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio></p>
...
|------------|---------|--------|--------|-----------|---------|
| #236 | ![fighting](../assets/types/fighting.png){: width='48'} | 0.7 m | 21.0 kg | 1. Guts<br>2. Vital-Spirit | #N/A |
