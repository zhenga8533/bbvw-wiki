...
| --- | --- |
| ![Official Artwork](../assets/sprites/pidove/official_artwork.png "Pidove") | ![Shiny Artwork](../assets/sprites/pidove/official_artwork_shiny.png "Pidove") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/pidove/front.gif "Pidove") | ![Back](../assets/sprites/pidove/back.gif "Pidove") | ![Front Shiny](../assets/sprites/pidove/front_shiny.gif "Pidove") | ![Back Shiny](../assets/sprites/pidove/back_shiny.gif "Pidove") |
...
|------------|---------|--------|--------|-----------|---------|
| #519 | ![normal](../assets/types/normal.png "Normal"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.3 m /<br>1.0 ft | 2.1 kg /<br>4.6 lbs |  | 1. <span class="tooltip" title="Deals more damage to a Pokémon of same gender.">Rivalry</span><br>2. <span class="tooltip" title="Heightens the critical- hit ratios of moves.">Super Luck</span> | #25 |
...
| 32 | <span class="tooltip" title="A two-turn attack. Blades of wind hit the foe on the second turn. It has a high critical-hit ratio.">Razor Wind</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 10 |
| 36 | <span class="tooltip" title="The user covers the foe with a mass of down that sharply lowers the Attack stat.">Feather Dance</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
...
| 43 | <span class="tooltip" title="An attack move that doubles its power if the user is poisoned, paralyzed, or has a burn.">Facade</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
| 46 | <span class="tooltip" title="The user whips up a turbulent whirlwind that ups the Speed of all party Pokémon for three turns.">Tailwind</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
