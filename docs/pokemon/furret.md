...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/furret/front.gif "Furret") | ![Back](../assets/sprites/furret/back.gif "Furret") | ![Front Shiny](../assets/sprites/furret/front_shiny.gif "Furret") | ![Back Shiny](../assets/sprites/furret/back_shiny.gif "Furret") |
...
|------------|---------|--------|--------|-----------|---------|
| #162 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 1.8 m /<br>5.9 ft | 32.5 kg /<br>71.7 lbs | <span class="tooltip" title="The Pokémon can check a foe’s held item.">Frisk</span><br><span class="tooltip" title="Prevents other Pokémon from lowering accuracy.">Keen Eye</span> | N/A |
...
| 25 | <span class="tooltip" title="The user chomps hard on the foe with its sharp front fangs. It cuts the target’s HP to half.">Super Fang</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 90 | 10 |
