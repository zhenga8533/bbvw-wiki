...
| --- | --- |
| ![Official Artwork](../assets/sprites/salamence/official_artwork.png "Salamence") | ![Shiny Artwork](../assets/sprites/salamence/official_artwork_shiny.png "Salamence") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/salamence/front.gif "Salamence") | ![Back](../assets/sprites/salamence/back.gif "Salamence") | ![Front Shiny](../assets/sprites/salamence/front_shiny.gif "Salamence") | ![Back Shiny](../assets/sprites/salamence/back_shiny.gif "Salamence") |
...
|------------|---------|--------|--------|-----------|---------|
| #373 | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.5 m /<br>4.9 ft | 102.6 kg /<br>226.2 lbs |  | 1. <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span><br>2. <span class="tooltip" title="Boosts Attack after knocking out any Pokémon.">Moxie</span> | N/A |
...
| 32 | <span class="tooltip" title="The user exhales a mighty gust that inflicts damage. It may also paralyze the target.">Dragon Breath</span> | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 60 | 100 | 20 |
...
| 53 | <span class="tooltip" title="The user crunches up the foe with sharp fangs. It may also lower the target’s Defense stat.">Crunch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
| 61 | <span class="tooltip" title="The user slashes the foe with huge, sharp claws.  ">Dragon Claw</span> | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
| 70 | <span class="tooltip" title="A reckless, life- risking tackle. It also damages the user by a fairly large amount, however.">Double Edge</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 15 |
| 75 | <span class="tooltip" title="The user vigorously performs a mystic, powerful dance that boosts its Attack and Speed stats.">Dragon Dance</span> | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
