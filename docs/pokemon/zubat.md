...
|------------|---------|--------|--------|-----------|---------|
| #41 | ![poison](../assets/types/poison.png "Poison"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.8 m /<br>2.6 ft | 7.5 kg /<br>16.5 lbs | <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br><span class="tooltip" title="Passes through the foe’s barrier and strikes.">Infiltrator</span> | N/A |
