...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/feebas/front.gif "Feebas") | ![Back](../assets/sprites/feebas/back.gif "Feebas") | ![Front Shiny](../assets/sprites/feebas/front_shiny.gif "Feebas") | ![Back Shiny](../assets/sprites/feebas/back_shiny.gif "Feebas") |
...
|------------|---------|--------|--------|-----------|---------|
| #349 | ![water](../assets/types/water.png "Water"){: width="48"} | 0.6 m /<br>2.0 ft | 7.4 kg /<br>16.3 lbs |  | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in rain.">Swift Swim</span><br>2. <span class="tooltip" title="Powers up moves of the same type.">Adaptability</span> | N/A |
