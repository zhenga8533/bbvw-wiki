...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/gliscor/official_artwork.png "Gliscor") | ![Shiny Artwork](../assets/sprites/gliscor/official_artwork_shiny.png "Gliscor") |
...
|-------|-------|------|-------|
| ![Gliscor](../assets/sprites/gliscor/front.gif "Gliscor: If it succeeds in catching even a faint breeze properly, it can circle the globe without flapping once.") | ![Gliscor](../assets/sprites/gliscor/front_shiny.gif "Gliscor: If it succeeds in catching even a faint breeze properly, it can circle the globe without flapping once.") | ![Gliscor](../assets/sprites/gliscor/back.gif "Gliscor: If it succeeds in catching even a faint breeze properly, it can circle the globe without flapping once.") | ![Gliscor](../assets/sprites/gliscor/back_shiny.gif "Gliscor: If it succeeds in catching even a faint breeze properly, it can circle the globe without flapping once.") |
...
| 34 | <span class="tooltip" title="The user slashes the target the instant an opportunity arises. Critical hits land more easily.">Night Slash</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
