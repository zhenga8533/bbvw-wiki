...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/musharna/official_artwork.png "Musharna") | ![Shiny Artwork](../assets/sprites/musharna/official_artwork_shiny.png "Musharna") |
...
|-------|-------|------|-------|
| ![Musharna](../assets/sprites/musharna/front.gif "Musharna: With the mist from its forehead, it can create shapes of things from dreams it has eaten.") | ![Musharna](../assets/sprites/musharna/front_shiny.gif "Musharna: With the mist from its forehead, it can create shapes of things from dreams it has eaten.") | ![Musharna](../assets/sprites/musharna/back.gif "Musharna: With the mist from its forehead, it can create shapes of things from dreams it has eaten.") | ![Musharna](../assets/sprites/musharna/back_shiny.gif "Musharna: With the mist from its forehead, it can create shapes of things from dreams it has eaten.") |
...
|------------|---------|--------|--------|-----------|---------|
| #518 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 1.1 m /<br>3.6 ft | 60.5 kg /<br>133.4 lbs | 1. <span class="tooltip" title="Anticipates an ally’s attack and dodges it.">Telepathy</span><br>2. <span class="tooltip" title="Boosts move power when the Pokémon moves last.">Analytic</span> | N/A |
