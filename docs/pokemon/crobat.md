...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/crobat/front.gif "Crobat") | ![Back](../assets/sprites/crobat/back.gif "Crobat") | ![Front Shiny](../assets/sprites/crobat/front_shiny.gif "Crobat") | ![Back Shiny](../assets/sprites/crobat/back_shiny.gif "Crobat") |
...
|------------|---------|--------|--------|-----------|---------|
| #169 | ![poison](../assets/types/poison.png "Poison"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.8 m /<br>5.9 ft | 75.0 kg /<br>165.3 lbs |  | 1. <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br>2. <span class="tooltip" title="Passes through the foe’s barrier and strikes.">Infiltrator</span> | N/A |
