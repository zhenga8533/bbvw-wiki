...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/shaymin-sky/official_artwork.png "Shaymin Sky") | ![Shiny Artwork](../assets/sprites/shaymin-sky/official_artwork_shiny.png "Shaymin Sky") |
...
|-------|-------|------|-------|
| ![Shaymin Sky](../assets/sprites/shaymin-sky/front.gif "Shaymin Sky: The flowers all over its body burst into bloom if it is lovingly hugged and senses gratitude.") | ![Shaymin Sky](../assets/sprites/shaymin-sky/front_shiny.gif "Shaymin Sky: The flowers all over its body burst into bloom if it is lovingly hugged and senses gratitude.") | ![Shaymin Sky](../assets/sprites/shaymin-sky/back.gif "Shaymin Sky: The flowers all over its body burst into bloom if it is lovingly hugged and senses gratitude.") | ![Shaymin Sky](../assets/sprites/shaymin-sky/back_shiny.gif "Shaymin Sky: The flowers all over its body burst into bloom if it is lovingly hugged and senses gratitude.") |
...
| 28 | <span class="tooltip" title="The user lunges at the target at a speed that makes it almost invisible. It is sure to strike first.">Quick Attack</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 100 | 30 |
...
| 91 | <span class="tooltip" title="The user whips up a storm of leaves around the target. The attack’s recoil harshly reduces the user’s Sp. Atk stat.">Leaf Storm</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 130 | 90 | 5 |
