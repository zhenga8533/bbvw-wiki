...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/muk/front.gif "Muk") | ![Back](../assets/sprites/muk/back.gif "Muk") | ![Front Shiny](../assets/sprites/muk/front_shiny.gif "Muk") | ![Back Shiny](../assets/sprites/muk/back_shiny.gif "Muk") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Hp<br>1 Attack | 75 | 70 | 175 | Medium | <span class="tooltip" title="An item to be held by a Pokémon. It is a bizarre orb that badly poisons the holder in battle.">Toxic Orb</span> (50%) |
...
| 64 | <span class="tooltip" title="The user faints upon using this move. In return, it sharply lowers the target’s Attack and Sp. Atk.">Memento</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 10 |
