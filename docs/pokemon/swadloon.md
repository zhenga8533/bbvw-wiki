...
| --- | --- |
| ![Official Artwork](../assets/sprites/swadloon/official_artwork.png "Swadloon") | ![Shiny Artwork](../assets/sprites/swadloon/official_artwork_shiny.png "Swadloon") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/swadloon/front.gif "Swadloon") | ![Back](../assets/sprites/swadloon/back.gif "Swadloon") | ![Front Shiny](../assets/sprites/swadloon/front_shiny.gif "Swadloon") | ![Back Shiny](../assets/sprites/swadloon/back_shiny.gif "Swadloon") |
...
|------------|---------|--------|--------|-----------|---------|
| #541 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.5 m /<br>1.6 ft | 7.3 kg /<br>16.1 lbs |  | 1. <span class="tooltip" title="Prevents problems with status in sunny weather.">Leaf Guard</span><br>2. <span class="tooltip" title="Protects the Pokémon from damage from weather.">Overcoat</span> | #47 |
...
| 20 | <span class="tooltip" title="It enables the user to evade all attacks. Its chance of failing rises if it is used in succession.">Protect</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
| 20 | <span class="tooltip" title="The user restores its own HP. The amount of HP regained varies with the weather.">Synthesis</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
