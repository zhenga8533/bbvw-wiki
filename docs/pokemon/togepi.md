...
|------------|---------|--------|--------|-----------|---------|
| #175 | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.3 m /<br>1.0 ft | 1.5 kg /<br>3.3 lbs | <span class="tooltip" title="Heightens the critical- hit ratios of moves.">Super Luck</span><br><span class="tooltip" title="Boosts the likelihood of added effects appearing.">Serene Grace</span> | N/A |
