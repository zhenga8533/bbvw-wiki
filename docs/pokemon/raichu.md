...
|------------|---------|--------|--------|-----------|---------|
| #26 | ![electric](../assets/types/electric.png){: width='48'} | 0.8 m /<br>2.6 ft | 30.0 kg /<br>66.1 lbs | <span class="tooltip" title="Contact with the Pokémon may cause paralysis.">Static</span><br><span class="tooltip" title="Draws in all Electric-type moves to up Sp. Attack.">Lightning Rod</span> | N/A |
...
| 1 | <span class="tooltip" title="A strong electric blast is loosed at the foe. It may also leave the foe paralyzed.">Thunderbolt</span> | ![electric](../assets/types/electric.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 90 | 100 | 15 |
