...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/rampardos/front.gif "Rampardos") | ![Back](../assets/sprites/rampardos/back.gif "Rampardos") | ![Front Shiny](../assets/sprites/rampardos/front_shiny.gif "Rampardos") | ![Back Shiny](../assets/sprites/rampardos/back_shiny.gif "Rampardos") |
...
|------------|---------|--------|--------|-----------|---------|
| #409 | ![rock](../assets/types/rock.png "Rock"){: width="48"} | 1.6 m /<br>5.2 ft | 102.5 kg /<br>226.0 lbs |  | 1. <span class="tooltip" title="Moves can be used regardless of Abilities.">Mold Breaker</span><br>2. <span class="tooltip" title="Removes added effects to increase move damage.">Sheer Force</span> | N/A |
...
| 24 | <span class="tooltip" title="If the foe has already taken some damage in the same turn, this attack’s power is doubled.">Assurance</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 10 |
| 28 | <span class="tooltip" title="Inflicts regular damage.  Damage calculation ignores the target's stat modifiers, including evasion.">Chip Away</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
...
| 64 | <span class="tooltip" title="The user crunches up the foe with sharp fangs. It may also lower the target’s Defense stat.">Crunch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
