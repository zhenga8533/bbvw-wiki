...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/seedot/official_artwork.png "Seedot") | ![Shiny Artwork](../assets/sprites/seedot/official_artwork_shiny.png "Seedot") |
...
|-------|-------|------|-------|
| ![Seedot](../assets/sprites/seedot/front.gif "Seedot: When it dangles from a tree branch, it looks just like an acorn. It enjoys scaring other Pokémon.") | ![Seedot](../assets/sprites/seedot/front_shiny.gif "Seedot: When it dangles from a tree branch, it looks just like an acorn. It enjoys scaring other Pokémon.") | ![Seedot](../assets/sprites/seedot/back.gif "Seedot: When it dangles from a tree branch, it looks just like an acorn. It enjoys scaring other Pokémon.") | ![Seedot](../assets/sprites/seedot/back_shiny.gif "Seedot: When it dangles from a tree branch, it looks just like an acorn. It enjoys scaring other Pokémon.") |
...
|------------|---------|--------|--------|-----------|---------|
| #273 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.5 m /<br>1.6 ft | 4.0 kg /<br>8.8 lbs | 1. <span class="tooltip" title="Steals an item when hit by another Pokémon.">Pickpocket</span><br>2. <span class="tooltip" title="The Pokémon awakens quickly from sleep.">Early Bird</span> | N/A |
...
| 17 | <span class="tooltip" title="The user slams a barrage of hard-shelled seeds down on the target from above.">Seed Bomb</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
...
| 26 | <span class="tooltip" title="A seed is planted on the target. It steals some HP from the target every turn.">Leech Seed</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 90 | 10 |
...
| 43 | <span class="tooltip" title="The user explodes to inflict damage on those around it. The user faints upon using this move.">Explosion</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 250 | 100 | 5 |
