...
|------------|---------|--------|--------|-----------|---------|
| #253 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.9 m /<br>3.0 ft | 21.6 kg /<br>47.6 lbs | <span class="tooltip" title="Powers up Grass-type moves in a pinch.">Overgrow</span><br><span class="tooltip" title="Powers up moves of the same type.">Adaptability</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Speed | 45 | 50 | 142 | Medium Slow | <span class="tooltip" title="An item to be held by a Pokémon. It is a seed imbued with life that ups the power of Grass-type moves.">Miracle Seed</span> (50%) |
