...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/grovyle/official_artwork.png "Grovyle") | ![Shiny Artwork](../assets/sprites/grovyle/official_artwork_shiny.png "Grovyle") |
...
|-------|-------|------|-------|
| ![Grovyle](../assets/sprites/grovyle/front.gif "Grovyle: It lives in dense jungles. While  closing in on its prey, it leaps from branch to branch.") | ![Grovyle](../assets/sprites/grovyle/front_shiny.gif "Grovyle: It lives in dense jungles. While  closing in on its prey, it leaps from branch to branch.") | ![Grovyle](../assets/sprites/grovyle/back.gif "Grovyle: It lives in dense jungles. While  closing in on its prey, it leaps from branch to branch.") | ![Grovyle](../assets/sprites/grovyle/back_shiny.gif "Grovyle: It lives in dense jungles. While  closing in on its prey, it leaps from branch to branch.") |
...
|------------|---------|--------|--------|-----------|---------|
| #253 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.9 m /<br>3.0 ft | 21.6 kg /<br>47.6 lbs | 1. <span class="tooltip" title="Powers up Grass-type moves in a pinch.">Overgrow</span><br>2. <span class="tooltip" title="Powers up moves of the same type.">Adaptability</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Spd | 45 | 50 | 142 | Medium Slow | <span class="tooltip" title="An item to be held by a Pokémon. It is a seed imbued with life that ups the power of Grass-type moves.">Miracle Seed</span> (50%) |
...
| 16 | <span class="tooltip" title="The target is slashed with scythes or claws. Its power increases if it hits in succession.">Fury Cutter</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 95 | 20 |
...
| 47 | <span class="tooltip" title="It enables the user to evade all attacks. Its chance of failing rises if it is used in succession.">Detect</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
| 53 | <span class="tooltip" title="A restrained attack that prevents the target from fainting. The target is left with at least 1 HP.">False Swipe</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 100 | 40 |
| 59 | <span class="tooltip" title="The user whips up a storm of leaves around the target. The attack’s recoil harshly reduces the user’s Sp. Atk stat.">Leaf Storm</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 130 | 90 | 5 |
