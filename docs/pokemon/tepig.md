...
| --- | --- |
| ![Official Artwork](../assets/sprites/tepig/official_artwork.png "Tepig") | ![Shiny Artwork](../assets/sprites/tepig/official_artwork_shiny.png "Tepig") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/tepig/front.gif "Tepig") | ![Back](../assets/sprites/tepig/back.gif "Tepig") | ![Front Shiny](../assets/sprites/tepig/front_shiny.gif "Tepig") | ![Back Shiny](../assets/sprites/tepig/back_shiny.gif "Tepig") |
...
|------------|---------|--------|--------|-----------|---------|
| #498 | ![fire](../assets/types/fire.png "Fire"){: width="48"} | 0.5 m /<br>1.6 ft | 9.9 kg /<br>21.8 lbs | <span class="tooltip" title="Powers up Fire-type moves in a pinch.">Blaze</span><br><span class="tooltip" title="Powers up moves of the same type.">Adaptability</span> | #4 |
...
| 19 | <span class="tooltip" title="The foe is attacked with a discharge of filthy gases. It may also poison the target.">Smog</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 30 | 70 | 20 |
...
| 37 | <span class="tooltip" title="The user delivers a life-endangering head butt at full power. The user also takes terrible damage.">Head Smash</span> | ![rock](../assets/types/rock.png "Rock"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 150 | 80 | 5 |
| 39 | <span class="tooltip" title="The foe is scared off, to be replaced by another Pokémon in its party. In the wild, the battle ends.">Roar</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
