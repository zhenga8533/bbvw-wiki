...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/vullaby/front.gif "Vullaby") | ![Back](../assets/sprites/vullaby/back.gif "Vullaby") | ![Front Shiny](../assets/sprites/vullaby/front_shiny.gif "Vullaby") | ![Back Shiny](../assets/sprites/vullaby/back_shiny.gif "Vullaby") |
...
|------------|---------|--------|--------|-----------|---------|
| #629 | ![dark](../assets/types/dark.png "Dark"){: width="48"} ![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.5 m /<br>1.6 ft | 9.0 kg /<br>19.8 lbs | <span class="tooltip" title="Protects the Pokémon from Defense-lowering attacks.">Big Pecks</span><br><span class="tooltip" title="Protects the Pokémon from damage from weather.">Overcoat</span> | #135 |
...
| 50 | <span class="tooltip" title="It prevents the foe from using its held item. Its Trainer is also prevented from using items on it.">Embargo</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
...
| 64 | <span class="tooltip" title="The user counters the foe by mimicking the move last used by the foe.">Mirror Move</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
