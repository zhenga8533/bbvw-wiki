...
|------------|---------|--------|--------|-----------|---------|
| #230 | ![water](../assets/types/water.png){: width='48'} ![dragon](../assets/types/dragon.png){: width='48'} | 1.8 m /<br>5.9 ft | 152.0 kg /<br>335.1 lbs | <span class="tooltip" title="Boosts the Pokémon’s Speed in rain.">Swift Swim</span><br><span class="tooltip" title="Powers up moves if they become critical hits.">Sniper</span> | N/A |
...
| 48 | <span class="tooltip" title="The user vigorously performs a mystic, powerful dance that boosts its Attack and Speed stats.">Dragon Dance</span> | ![dragon](../assets/types/dragon.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 20 |
