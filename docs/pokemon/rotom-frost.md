...
|------------|---------|--------|--------|-----------|---------|
| #10010 | ![electric](../assets/types/electric.png){: width='48'} ![ice](../assets/types/ice.png){: width='48'} | 0.3 m /<br>1.0 ft | 0.3 kg /<br>0.7 lbs | <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span> | N/A |
...
| 1 | <span class="tooltip" title="Inflicts regular damage.  Lowers the target's Speed by one stage.">Glaciate</span> | ![ice](../assets/types/ice.png){: width='48'} | ![special](../assets/move_category/special.png){: width='36'} | 65 | 95 | 10 |
