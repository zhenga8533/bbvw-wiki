...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/rotom-frost/official_artwork.png "Rotom Frost") | ![Shiny Artwork](../assets/sprites/rotom-frost/official_artwork_shiny.png "Rotom Frost") |
...
|-------|-------|------|-------|
| ![Rotom Frost](../assets/sprites/rotom-frost/front.gif "Rotom Frost: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Frost](../assets/sprites/rotom-frost/front_shiny.gif "Rotom Frost: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Frost](../assets/sprites/rotom-frost/back.gif "Rotom Frost: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") | ![Rotom Frost](../assets/sprites/rotom-frost/back_shiny.gif "Rotom Frost: Its electric-like body can enter some kinds of machines and take control in order to make mischief.") |
...
| 1 | <span class="tooltip" title="The user attacks by blowing freezing cold air at opposing Pokémon. This attack reduces the targets’ Speed stat.">Glaciate</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 95 | 10 |
...
Rotom Frost cannot learn any moves from tutors.
