...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/mime-jr/front.gif "Mime Jr") | ![Back](../assets/sprites/mime-jr/back.gif "Mime Jr") | ![Front Shiny](../assets/sprites/mime-jr/front_shiny.gif "Mime Jr") | ![Back Shiny](../assets/sprites/mime-jr/back_shiny.gif "Mime Jr") |
...
|------------|---------|--------|--------|-----------|---------|
| #439 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"}<br>![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.6 m /<br>2.0 ft | 13.0 kg /<br>28.7 lbs |  | 1. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span><br>2. <span class="tooltip" title="Reduces damage from supereffective attacks.">Filter</span> | N/A |
