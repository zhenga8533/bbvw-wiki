...
|------------|---------|--------|--------|-----------|---------|
| #301 | ![normal](../assets/types/normal.png){: width='48'} | 1.1 m /<br>3.6 ft | 32.6 kg /<br>71.9 lbs | <span class="tooltip" title="All the Pokémon’s moves become the Normal type.">Normalize</span><br><span class="tooltip" title="Makes status-changing moves more likely to miss.">Wonder Skin</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Hp<br>1 Speed | 60 | 70 | 140 | Fast | <span class="tooltip" title="If held by a Pokémon, it restores a move’s PP by 10.">Leppa Berry</span> (5%) |
...
| 25 | <span class="tooltip" title="A self-healing move. The user restores its own HP by up to half of its maximum HP in the next turn.">Wish</span> | ![normal](../assets/types/normal.png){: width='48'} | ![status](../assets/move_category/status.png){: width='36'} | — | — | 10 |
...
| 45 | <span class="tooltip" title="This move enables the user to attack first. It fails if the foe is not readying an attack, however.">Sucker Punch</span> | ![dark](../assets/types/dark.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 70 | 100 | 5 |
