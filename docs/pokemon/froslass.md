...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/froslass/front.gif "Froslass") | ![Back](../assets/sprites/froslass/back.gif "Froslass") | ![Front Shiny](../assets/sprites/froslass/front_shiny.gif "Froslass") | ![Back Shiny](../assets/sprites/froslass/back_shiny.gif "Froslass") |
...
| 28 | <span class="tooltip" title="This attack inflicts high damage on a sleeping foe. It also wakes the foe up, however.">Wake Up Slap</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 10 |
...
| 59 | <span class="tooltip" title="When this move is used, if the user faints, the foe that landed the knockout hit also faints.">Destiny Bond</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
