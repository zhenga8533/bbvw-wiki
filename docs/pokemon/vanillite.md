...
| --- | --- |
| ![Official Artwork](../assets/sprites/vanillite/official_artwork.png "Vanillite") | ![Shiny Artwork](../assets/sprites/vanillite/official_artwork_shiny.png "Vanillite") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/vanillite/front.gif "Vanillite") | ![Back](../assets/sprites/vanillite/back.gif "Vanillite") | ![Front Shiny](../assets/sprites/vanillite/front_shiny.gif "Vanillite") | ![Back Shiny](../assets/sprites/vanillite/back_shiny.gif "Vanillite") |
...
|------------|---------|--------|--------|-----------|---------|
| #582 | ![ice](../assets/types/ice.png "Ice"){: width="48"} | 0.4 m /<br>1.3 ft | 5.7 kg /<br>12.6 lbs |  | 1. <span class="tooltip" title="The Pokémon gradually regains HP in a hailstorm.">Ice Body</span><br>2. <span class="tooltip" title="Physical attacks lower Defense and raise Speed.">Weak Armor</span> | #88 |
...
| 44 | <span class="tooltip" title="A retaliation move that counters any special attack, inflicting double the damage taken.">Mirror Coat</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 100 | 20 |
| 49 | <span class="tooltip" title="A howling blizzard is summoned to strike the foe. It may also freeze the target solid.">Blizzard</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 110 | 70 | 5 |
| 53 | <span class="tooltip" title="The foe is attacked with a blast of absolute-zero cold. The foe instantly faints if it hits.">Sheer Cold</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 30 | 5 |
...
| --- | --- | --- | --- | --- | --- |
| <span class="tooltip" title="The user attacks with a chilling gust of powdery snow. It may also freeze the target.">Powder Snow</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 25 |
