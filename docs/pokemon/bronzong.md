...
| --- | --- |
| ![Official Artwork](../assets/sprites/bronzong/official_artwork.png "Bronzong") | ![Shiny Artwork](../assets/sprites/bronzong/official_artwork_shiny.png "Bronzong") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/bronzong/front.gif "Bronzong") | ![Back](../assets/sprites/bronzong/back.gif "Bronzong") | ![Front Shiny](../assets/sprites/bronzong/front_shiny.gif "Bronzong") | ![Back Shiny](../assets/sprites/bronzong/back_shiny.gif "Bronzong") |
...
|------------|---------|--------|--------|-----------|---------|
| #437 | ![steel](../assets/types/steel.png "Steel"){: width="48"}<br>![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 1.3 m /<br>4.3 ft | 187.0 kg /<br>412.3 lbs |  | 1. <span class="tooltip" title="Gives full immunity to all Ground-type moves.">Levitate</span><br>2. <span class="tooltip" title="Weakens the power of Fire-type moves.">Heatproof</span> | N/A |
...
| 38 | <span class="tooltip" title="The user tackles the foe with a high-speed spin. The slower the user, the greater the damage.">Gyro Ball</span> | ![steel](../assets/types/steel.png "Steel"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 5 |
...
| 50 | <span class="tooltip" title="The user draws up to the foe disarmingly, then throws a sucker punch. It hits without fail.">Feint Attack</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | — | 20 |
| 61 | <span class="tooltip" title="If the user can use this attack after the foe attacks, its power is doubled. ">Payback</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 100 | 10 |
| 67 | <span class="tooltip" title="The user prevents the foe from using any HP-recovery moves for five turns. ">Heal Block</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
