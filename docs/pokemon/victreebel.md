...
| --- | --- |
| ![Official Artwork](../assets/sprites/victreebel/official_artwork.png "Victreebel") | ![Shiny Artwork](../assets/sprites/victreebel/official_artwork_shiny.png "Victreebel") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/victreebel/front.gif "Victreebel") | ![Back](../assets/sprites/victreebel/back.gif "Victreebel") | ![Front Shiny](../assets/sprites/victreebel/front_shiny.gif "Victreebel") | ![Back Shiny](../assets/sprites/victreebel/back_shiny.gif "Victreebel") |
...
|------------|---------|--------|--------|-----------|---------|
| #71 | ![grass](../assets/types/grass.png "Grass"){: width="48"}<br>![poison](../assets/types/poison.png "Poison"){: width="48"} | 1.7 m /<br>5.6 ft | 15.5 kg /<br>34.2 lbs |  | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in sunshine.">Chlorophyll</span><br>2. <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span> | N/A |
...
| 17 | <span class="tooltip" title="This move enables the user to attack first. It fails if the foe is not readying an attack, however.">Sucker Punch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
| 27 | <span class="tooltip" title="Inflicts regular damage.  Has a 50% chance to lower the target's accuracy by one stage.">Leaf Tornado</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 90 | 10 |
...
| 47 | <span class="tooltip" title="The foe is slashed with a sharp leaf. It has a high critical-hit ratio. ">Leaf Blade</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 100 | 15 |
| 47 | <span class="tooltip" title="A storm of sharp leaves is whipped up. The attack’s recoil sharply reduces the user’s Sp. Atk stat.">Leaf Storm</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 130 | 90 | 5 |
