...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/skuntank/front.gif "Skuntank") | ![Back](../assets/sprites/skuntank/back.gif "Skuntank") | ![Front Shiny](../assets/sprites/skuntank/front_shiny.gif "Skuntank") | ![Back Shiny](../assets/sprites/skuntank/back_shiny.gif "Skuntank") |
...
| 71 | <span class="tooltip" title="Inflicts regular damage.  Damage is calculated using the target's attacking stat rather than the user's.">Foul Play</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 95 | 100 | 15 |
