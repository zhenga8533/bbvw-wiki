...
| --- | --- |
| ![Official Artwork](../assets/sprites/dodrio/official_artwork.png "Dodrio") | ![Shiny Artwork](../assets/sprites/dodrio/official_artwork_shiny.png "Dodrio") |
...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/dodrio/front.gif "Dodrio") | ![Back](../assets/sprites/dodrio/back.gif "Dodrio") | ![Front Shiny](../assets/sprites/dodrio/front_shiny.gif "Dodrio") | ![Back Shiny](../assets/sprites/dodrio/back_shiny.gif "Dodrio") |

### Female Sprites

| Front | Back | Front Shiny | Back Shiny |
| --- | --- | --- | --- |
| ![Front](../assets/sprites/dodrio/front_female.gif "Dodrio") | ![Back](../assets/sprites/dodrio/back_female.gif "Dodrio") | ![Front Shiny](../assets/sprites/dodrio/front_shiny_female.gif "Dodrio") | ![Back Shiny](../assets/sprites/dodrio/back_shiny_female.gif "Dodrio") |
...
|------------|---------|--------|--------|-----------|---------|
| #85 | ![normal](../assets/types/normal.png "Normal"){: width="48"} ![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.8 m /<br>5.9 ft | 85.2 kg /<br>187.8 lbs | <span class="tooltip" title="Maxes Attack after taking a critical hit.">Anger Point</span><br><span class="tooltip" title="The Pokémon awakens quickly from sleep.">Early Bird</span> | N/A |
...
| 14 | <span class="tooltip" title="The foe is jabbed repeatedly with a horn or beak two to five times in a row. ">Fury Attack</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 15 | 85 | 20 |
...
| 28 | <span class="tooltip" title="The user applies pressure to stress points, sharply boosting one of its stats.">Acupressure</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 30 |
...
| 34 | <span class="tooltip" title="The user strikes with a simultaneous three- beam attack. May also paralyze, burn, or freeze the target.">Tri Attack</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 10 |
...
| 66 | <span class="tooltip" title="The user tucks in its wings and charges from a low altitude. The user also takes serious damage.">Brave Bird</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 15 |
