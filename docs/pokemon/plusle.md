...
|------------|---------|--------|--------|-----------|---------|
| #311 | ![electric](../assets/types/electric.png){: width='48'} | 0.4 m /<br>1.3 ft | 4.2 kg /<br>9.3 lbs | <span class="tooltip" title="Ups Sp. Atk if another Pokémon has Plus or Minus.">Plus</span> | N/A |
...
| 51 | <span class="tooltip" title="This move can be used only after the user has used all the other moves it knows in the battle.">Last Resort</span> | ![normal](../assets/types/normal.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 140 | 100 | 5 |
