...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/luvdisc/front.gif "Luvdisc") | ![Back](../assets/sprites/luvdisc/back.gif "Luvdisc") | ![Front Shiny](../assets/sprites/luvdisc/front_shiny.gif "Luvdisc") | ![Back Shiny](../assets/sprites/luvdisc/back_shiny.gif "Luvdisc") |
...
|------------|---------|--------|--------|-----------|---------|
| #370 | ![water](../assets/types/water.png "Water"){: width="48"} ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.6 m /<br>2.0 ft | 8.7 kg /<br>19.2 lbs | <span class="tooltip" title="Boosts the Pokémon’s Speed in rain.">Swift Swim</span><br><span class="tooltip" title="Heals status problems if it is raining.">Hydration</span> | N/A |
...
| 14 | <span class="tooltip" title="A reckless, full-body charge attack for slamming into the foe. It also damages the user a little.">Take Down</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 85 | 20 |
...
| 27 | <span class="tooltip" title="If it is the opposite gender of the user, the foe becomes infatuated and less likely to attack.">Attract</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
...
| 37 | <span class="tooltip" title="The user kisses the foe with a sweet, angelic cuteness that causes confusion. ">Sweet Kiss</span> | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 75 | 10 |
...
| 51 | <span class="tooltip" title="If it is the opposite gender of the user, the foe is charmed into sharply lowering its Sp. Atk stat.">Captivate</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
