...
|------------|---------|--------|--------|-----------|---------|
| #78 | ![fire](../assets/types/fire.png "Fire"){: width="48"} | 1.7 m /<br>5.6 ft | 95.0 kg /<br>209.4 lbs | <span class="tooltip" title="Contact with the Pokémon may burn the attacker.">Flame Body</span><br><span class="tooltip" title="It powers up Fire-type moves if it’s hit by one.">Flash Fire</span> | N/A |
