...
|------------|---------|--------|--------|-----------|---------|
| #607 | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"}<br>![fire](../assets/types/fire.png "Fire"){: width="48"} | 0.3 m /<br>1.0 ft | 3.1 kg /<br>6.8 lbs |  | 1. <span class="tooltip" title="It powers up Fire-type moves if it’s hit by one.">Flash Fire</span><br>2. <span class="tooltip" title="Contact with the Pokémon may burn the attacker.">Flame Body</span> | #113 |
