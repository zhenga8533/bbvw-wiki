...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/axew/front.gif "Axew") | ![Back](../assets/sprites/axew/back.gif "Axew") | ![Front Shiny](../assets/sprites/axew/front_shiny.gif "Axew") | ![Back Shiny](../assets/sprites/axew/back_shiny.gif "Axew") |
...
|------------|---------|--------|--------|-----------|---------|
| #610 | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"} | 0.6 m /<br>2.0 ft | 18.0 kg /<br>39.7 lbs |  | 1. <span class="tooltip" title="Deals more damage to a Pokémon of same gender.">Rivalry</span><br>2. <span class="tooltip" title="Moves can be used regardless of Abilities.">Mold Breaker</span> | #116 |
...
| 51 | <span class="tooltip" title="A vicious, tearing attack with pincers. The foe will faint instantly if this attack hits.">Guillotine</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 30 | 5 |
