...
| --- | --- | --- | --- |
| ![Front](../assets/sprites/excadrill/front.gif "Excadrill") | ![Back](../assets/sprites/excadrill/back.gif "Excadrill") | ![Front Shiny](../assets/sprites/excadrill/front_shiny.gif "Excadrill") | ![Back Shiny](../assets/sprites/excadrill/back_shiny.gif "Excadrill") |
...
|------------|---------|--------|--------|-----------|---------|
| #530 | ![ground](../assets/types/ground.png "Ground"){: width="48"}<br>![steel](../assets/types/steel.png "Steel"){: width="48"} | 0.7 m /<br>2.3 ft | 40.4 kg /<br>89.1 lbs |  | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in a sandstorm.">Sand Rush</span><br>2. <span class="tooltip" title="Moves can be used regardless of Abilities.">Mold Breaker</span> | #36 |
...
| 55 | <span class="tooltip" title="Inflicts regular damage.  User's critical hit rate is one level higher when using this move.">Drill Run</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 95 | 10 |
| 62 | <span class="tooltip" title="The user opens up a fissure in the ground and drops the foe in. The target instantly faints if it hits.">Fissure</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 30 | 5 |
